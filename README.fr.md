# Formidable GPT Image 2 Prompts

Une collection organisée de prompts GPT Image 2, classée par cas d'utilisation.
...
### Maquette UI du flux en direct e-commerce

![Maquette UI du flux en direct e-commerce](https://cdn.gptimagine.org/prompt-library/e-commerce-live-stream-ui-mockup.jpg)
...
**Source**  
[@sjbbxhz](https://x.com/sjbbxhz/status/2045684734714380687)

### Image principale e-commerce - Storyboard TVC produit à 9 panneaux

![Image principale e-commerce - Storyboard TVC produit à 9 panneaux](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-9-panel-product-tvc-storyboard.jpg)
...
**Source**  
[@Magncsans](https://x.com/Magncsans/status/2047876253898903594)

### Image principale e-commerce - Infographie écouteurs e-commerce

![Image principale e-commerce - Infographie écouteurs e-commerce](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-earbuds-e-commerce-infographic.jpg)
...
**Source**  
[@SPEEDAI07](https://x.com/SPEEDAI07/status/2047981795552153860)

### Image principale e-commerce - Feuille de présentation du design industriel

![Image principale e-commerce - Feuille de présentation du design industriel](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-industrial-design-presentation-sheet.jpg)
...
**Source**  
[@ShamsAmin56](https://x.com/ShamsAmin56/status/2047627860752621647)

### Image principale e-commerce - Image principale du ventilateur e-commerce japonais

![Image principale e-commerce - Image principale du ventilateur e-commerce japonais](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-japanese-e-commerce-fan-main-image.jpg)

**Prompt**

````text
{"type":"e-commerce product main image mockup","style":"clean Japanese marketplace listing visual, minimal, bright, commercial studio composite","background":{"color":"#FFFFFF"},"product":{"category":"small USB rechargeable fan","design":"compact portable desk fan with circular grille, rose-gold accent ring at the center and side knob, flat base clip stand, usable as tabletop, clip-on, or hanging fan, head tilts and rotates vertically","main_color":"{argument name=\"main product color\" default=\"white\"}","variant_count":4,"variants":["white","navy","pink","black"]},"layout":{"canvas":"square composition with wide white negative space","sections":[{"title":"top-right color lineup","position":"upper right","count":4,"labels":["white","navy","pink","black"],"description":"four small product renders arranged in a 2 by 2 grid"},{"title":"instruction text block","position":"upper middle-right","count":6,"labels":["Amazon商品メイン画像","白背景（#FFFFFF）","台置き・クリップ・吊り下げの3WAY対応USB充電式小型扇風機、上下360度回転可能","中央にホワイトカラーを大きく配置","周囲にネイビー、ピンク、ブラックを小さく配置","4色カラーバリエーション表示"],"description":"rounded light gray note box with six lines of Japanese text"},{"title":"main product card","position":"bottom left","count":9,"labels":["台置き・クリップ","吊り下げ","上下360°回転","3WAY対応","USB充電式","小型扇風機","4","COLOR","white navy pink black"],"description":"large rounded rectangle product feature card with hero product and feature icons"}],"centerpiece":"oversized {argument name=\"main product color\" default=\"white\"} fan placed prominently inside the bottom product card, angled slightly to the right with soft shadow"},"feature_icons":{"count":3,"items":[{"label":"台置き・クリップ","description":"small circular inset showing the fan clipped to a wooden desk edge"},{"label":"吊り下げ","description":"small circular inset showing the fan hanging from above"},{"label":"上下360°回転","description":"small circular inset with a curved 360-degree arrow around the fan"}]},"text":{"headline":"{argument name=\"headline text\" default=\"3WAY対応\"}","subheadline":"{argument name=\"subheadline text\" default=\"USB充電式\"}","product_label":"{argument name=\"product label\" default=\"小型扇風機\"}","color_count":"4 COLOR"},"visual_details":{"materials":"matte plastic body with subtle metallic rose-gold accents","lighting":"soft high-key studio lighting, gentle gray shadows, crisp product cutout look","graphics":"teal accent labels and badges, thin gray borders, clean Japanese marketplace typography","composition_notes":"show the white fan largest in the center, with navy at lower left, pink at upper right, and black at lower right inside the product card; keep overall layout airy and premium"}}
````

**Source**  
[@中国輸入代行ラクファースト【RAKU FIRST公式】](https://x.com/RakuFirst/status/2048987964513149244#reversed-0)

### E-commerce Image principale - Grille éditoriale de soins de luxe

![E-commerce Image principale - Grille éditoriale de soins de luxe](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-luxury-skincare-editorial-grid.jpg)

**Prompt**

````text
Create a luxury skincare campaign collage in a 4 by 3 editorial grid with exactly 12 tiles, using a warm ivory, cream, champagne, and soft beige palette. The overall mood is ultra-refined, minimal, sensual, and high-end, with milky diffused lighting, soft cinematic shadows, glossy hydrated skin, and a premium beauty magazine aesthetic. Tile 1: a frosted glass skincare pump bottle standing on a clear shelf, matte cream body, metallic gold pump and collar, elegant serif branding reading {argument name="brand name" default="BLOOMGLOW"}, product name reading {argument name="product name" default="RADIANCE MOISTURIZING EMULSION"}, photographed against a creamy beige wall with diagonal sunlight. Tile 2: a macro swipe of thick white lotion on a smooth cream surface, sculptural texture, soft highlights. Tile 3: a close crop of a woman's head and neck from behind, dark hair in a clean low bun, luminous skin, ear visible, minimal composition. Tile 4: sheer cream curtains lit by sunlight with the shadow silhouette of leaves or flowers cast across them. Tile 5: close-up of a woman's bare shoulder and upper back, dewy glowing skin, one hand touching the shoulder, a thin streak of lotion trailing down the back, intimate skincare editorial framing. Tile 6: a glossy translucent droplet of emulsion resting on a creamy matte surface, macro product texture study. Tile 7: a close crop of the lower face, jawline, neck, and collarbone of the same woman, fingers gently touching the neck, fresh hydrated glow, soft shadow. Tile 8: another macro smear of white cream, smoother and broader than tile 2, with reflective wet highlights. Tile 9: sunlit rippling water in pale champagne tones, abstract liquid texture with sparkling reflections. Tile 10: the same skincare bottle lying diagonally on softly wrinkled satin or silk fabric, gentle sunlight, subtle shadow, branding visible. Tile 11: close-up of hands applying a white oval dollop of lotion onto the back of one hand with the fingertips of the other hand, elegant manicured natural nails. Tile 12: glossy neckline and shoulders of the woman, collarbones highlighted, luminous moisturized skin, dark hair partially visible at the top edge. Keep the composition clean and balanced with thin white dividers between all 12 panels. Style keywords: minimalist luxury, creamy soft light, premium cosmetic advertisement, tactile textures, hydration, skin radiance, cinematic beauty editorial, understated opulence, breathable moisture glow. No clutter, no bright colors, no props beyond bottle, fabric, water, curtains, and skincare textures.
````

**Source**  
[@gate回声虚空85返](https://x.com/cesar_t12/status/2049049606571573409#reversed-0)

### E-commerce Image principale - Panneau éditorial de mode minimaliste en écran partagé

![E-commerce Image principale - Panneau éditorial de mode minimaliste en écran partagé](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-minimalist-fashion-editorial-split-panel.jpg)

**Prompt**

````text
Left panel: Show a young man from the back standing inside a {argument name="setting" default="clean, minimal café or takeaway shop interior"}. He is wearing an {argument name="outfit" default="oﬀ-white oversized t-shirt"} with a " {argument name="logo" default="SHAMUS"} "logo printed large across the back,
and a matching light beige cap with the SHAMUS logo on it. The environment should have light wooden
counters and shelves, warm natural lighting, and minimal branded packaging displayed on the shelves
in the background. The mood should feel clean, airy, and contemporary. Right panel: Show a cropped
lifestyle shot of a person standing near a wooden doorway or wall, wearing a white long-sleeve shirt
and loose black pants, holding a white paper takeaway bag with a die-cut handle. The " SHAMUS" logo
Only the lower torso and hand should be visible for a stylish editorial composition
````

**Source**  
[@Al-Shamus](https://x.com/im_shahid7/status/2048976229626499285)

### E-commerce Image principale - Publicité produit minimaliste : PURE CRUNCH

![E-commerce Image principale - Publicité produit minimaliste : PURE CRUNCH](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-minimalist-product-ad-pure-crunch.jpg)
...
**Source**  
[@Strength04_X](https://x.com/Strength04_X/status/2047917220165231011)

### E-commerce Image principale - Publicité mode Crocs bleu pastel

![E-commerce Image principale - Publicité mode Crocs bleu pastel](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-pastel-blue-crocs-fashion-ad.jpg)
...
**Source**  
[@SPEEDAI07](https://x.com/SPEEDAI07/status/2047907058079650035)

### E-commerce Image principale - Photo studio de carte mère gaming premium

![E-commerce Image principale - Photo studio de carte mère gaming premium](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-premium-gaming-motherboard-studio-shot.jpg)
...
**Source**  
[@rojassartorio](https://x.com/rojassartorio/status/2048019666816163867)

### E-commerce Image principale - Panneau publicitaire de poudre de céréales premium

![E-commerce Image principale - Panneau publicitaire de poudre de céréales premium](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-premium-grain-powder-ad-board.jpg)
...
**Source**  
[@WooGabriel76263](https://x.com/WooGabriel76263/status/2047988112094101770)

### E-commerce Image principale - Photographie de produit avec GPT-Image-2

![E-commerce Image principale - Photographie de produit avec GPT-Image-2](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-product-photography-with-gpt-image-2.jpg)

**Prompt**

````text
A polished, high-end product photography scene showcases a confident young woman with {argument name="hair color" default="smooth dark hair"}, dressed in a soft pink textured top, standing against a minimalist grey studio backdrop. In the foreground, a sleek {argument name="product name" default="Ellie Beauty spray bottle"} takes center focus, sharply detailed with a reflective metallic label that shifts between green and gold tones. The composition is brought to life with dynamic lime-green motion streaks and floating rounded tags that call out key benefits such as “high-shine finish” and “heat defense up to 450°F” in bold, modern sans-serif typography. Soft, diffused studio lighting enhances the model’s natural features while producing crisp reflections along the bottle’s surface. In the upper corner, a striking lime-green headline poses the question, “{argument name="headline" default="What does it do?"}”, tying the layout together with a fresh, contemporary advertising feel and a shallow depth of field that keeps both the product and the model’s expression clear and compelling.
````

**Source**  
[@Jack](https://x.com/j_smeaton99/status/2048961423531991526)

### E-commerce Image principale - Photo studio de produit de soin

![E-commerce Image principale - Photo studio de produit de soin](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-skincare-product-studio-shot.jpg)
...
**Source**  
[@Strength04_X](https://x.com/Strength04_X/status/2047636636847231222)

### E-commerce Image principale - Publicité étiquette plantable pour t-shirt durable

![E-commerce Image principale - Publicité étiquette plantable pour t-shirt durable](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-sustainable-t-shirt-plantable-tag-ad.jpg)
...
**Source**  
[@Diplomeme](https://x.com/Diplomeme/status/2047957339974828092)

### E-commerce Image principale - Affiche publicitaire soda citron tropical

![E-commerce Image principale - Affiche publicitaire soda citron tropical](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-tropical-citrus-soda-ad-poster.jpg)
...
**Source**  
[@edimakorfr](https://x.com/edimakorfr/status/2047635133466124726)

### Infographie / Visuel éducatif - Kit de marque pour restaurant italien

![Infographie / Visuel éducatif - Kit de marque pour restaurant italien](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-italian-restaurant-brand-kit-board.jpg)

**Prompt**

````text
{"type":"restaurant brand kit board","brand":{"name":"{argument name=\"brand name\" default=\"TERRALUNA\"}","category":"Italian kitchen","tagline":"{argument name=\"tagline\" default=\"rooted in tradition, made for today\"}","brand feel":"elegant, organic, artisanal, Mediterranean, refined neighborhood dining"},"canvas":{"orientation":"square","background":"warm ivory paper texture","style":"premium branding presentation board with clean grid layout, thin divider lines, editorial spacing, muted natural lighting"},"layout":{"sections":[{"title":"BRAND KIT","position":"top-left overall header","count":1,"labels":["BRAND KIT"]},{"title":"ABOUT","position":"left upper column","count":1,"labels":["ABOUT"]},{"title":"LOGO VARIATIONS","position":"left lower column","count":3,"labels":["primary horizontal logo","reversed logo on dark green block","circular seal logo"]},{"title":"COLOR PALETTE","position":"center lower column","count":5,"labels":["#1F3D2E","#6B7F5E","#A9B186","#E4DFC8","#B55A3C"]},{"title":"TYPOGRAPHY","position":"center lower column beneath color palette","count":3,"labels":["PLAYFAIR DISPLAY","Lato Regular","Love Script"]},{"title":"PATTERNS & ICONS","position":"right lower column","count":6,"labels":["botanical leaf pattern on light background","food doodle pattern on dark green background","leaf sprig icon","tomato icon","wine bottle and glass icon","herb sprig icon"]},{"title":"brand values strip","position":"middle full-width dark green band","count":4,"labels":["AUTHENTIC","SEASONAL","HONEST","WELCOMING"]},{"title":"brand application","position":"bottom full-width row","count":4,"labels":["business card mockup","menu on clipboard","round hanging storefront sign","shopping bag and takeaway cup"]},{"title":"footer","position":"bottom edge","count":2,"labels":["TERRALUNA ITALIAN KITCHEN","grazie e a presto!"]}],"image_panels":{"count":4,"descriptions":["overhead plated pasta on ceramic dish in warm restaurant lighting","dark green menu or booklet with logo on linen surface and olive branch shadows","wine glasses and candle on restaurant table with olive branch in foreground","soft lifestyle ambience integrated into top collage"]}},"visuals":{"logo":{"motif":"hand-drawn olive branch above serif wordmark","wordmark_style":"large elegant serif capitals with wide tracking","subline":"ITALIAN KITCHEN"},"about_text":"{argument name=\"about text\" default=\"Terraluna is a neighborhood Italian restaurant that celebrates honest ingredients, timeless recipes, and the joy of gathering around the table.\"}","value_descriptions":["Rooted in Italian heritage and tradition.","We celebrate the best of every season.","Simple ingredients, exceptionally prepared.","A place for connection, community, and comfort."],"applications":{"business_card":{"colors":"cream and deep forest green","details":"minimal layout, logo centered, one card with contact details"},"menu":{"material":"cream paper on wooden clipboard","style":"clean menu typography with subtle olive sprig accent"},"signage":{"shape":"round projecting sign","colors":"deep green face with cream logo, black metal bracket"},"packaging":{"items":"kraft shopping bag and dark green takeaway cup","print":"logo with delicate olive branch illustration"}}},"palette":{"primary":"deep forest green","secondary":"sage green","accent":"muted olive","neutral":"warm cream","contrast":"terracotta rust"},"lighting":"soft warm natural light with gentle shadows from olive branches","materials":"linen, paper, ceramic, glass, kraft paper, matte ink","composition":"balanced brand presentation mood board, high-end hospitality identity showcase, realistic mockups mixed with flat design assets","render_quality":"ultra clean, polished, tasteful, cohesive, premium editorial brand sheet for a restaurant identity presentation"}
````

**Source**  
[@SRKDAN](https://x.com/SRKDAN/status/2049112850770149775#reversed-0)

### Modèle de prise de vue studio produit premium

![Modèle de prise de vue studio produit premium](https://cdn.gptimagine.org/prompt-library/premium-product-studio-shot-template.jpg)
...
**Source**  
[@PrometheanAIX](https://x.com/PrometheanAIX/status/2049141839882522707)


## marketing

### Grille de bannières publicitaires numériques japonaises à 4 panneaux

![Grille de bannières publicitaires numériques japonaises à 4 panneaux](https://cdn.gptimagine.org/prompt-library/4-panel-japanese-digital-ad-banner-grid.jpg)
...
**Source**  
[@makaneko_AI](https://x.com/makaneko_AI/status/2045764016858087720)

### Tableau d'identité de marque et de marchandises pour personnage d'anime

![Tableau d'identité de marque et de marchandises pour personnage d'anime](https://cdn.gptimagine.org/prompt-library/anime-character-brand-identity-and-merch-board.jpg)
...
**Source**  
[@chi_vc_](https://x.com/chi_vc_/status/2046061073720369228)

### Interface utilisateur d'étude de cas marketing en mode sombre

![Interface utilisateur d'étude de cas marketing en mode sombre](https://cdn.gptimagine.org/prompt-library/dark-mode-marketing-case-study-ui.jpg)
...
**Source**  
[@IndieDevHailey](https://x.com/IndieDevHailey/status/2044974254769463312)

### Publicité éditoriale pour le sweat-shirt Osaka Six

![Publicité éditoriale pour le sweat-shirt Osaka Six](https://cdn.gptimagine.org/prompt-library/editorial-osaka-six-sweatshirt-ad.jpg)
...
**Source**  
[@_LaurentB](https://x.com/_LaurentB/status/2048126606313464040)

### Publicité éditoriale pour un flacon de parfum dans de la fourrure dorée

![Publicité éditoriale pour un flacon de parfum dans de la fourrure dorée](https://cdn.gptimagine.org/prompt-library/editorial-perfume-bottle-in-golden-fur.jpg)
...
**Source**  
[@Salmaaboukarr](https://x.com/Salmaaboukarr/status/2048103506125463983)

### Flyer de livraison de nourriture japonaise-chinoise

![Flyer de livraison de nourriture japonaise-chinoise](https://cdn.gptimagine.org/prompt-library/japanese-chinese-food-delivery-flyer.jpg)
...
**Source**  
[@xc5_](https://x.com/xc5_/status/2048310696686014935)

### Publicité pour montre chronographe de luxe

![Publicité pour montre chronographe de luxe](https://cdn.gptimagine.org/prompt-library/luxury-chronograph-watch-ad.jpg)
...
**Source**  
[@AlwaveNazca](https://x.com/AlwaveNazca/status/2048147643809865950)

### Modèle miniature de ville de Dubaï de luxe

![Modèle miniature de ville de Dubaï de luxe](https://cdn.gptimagine.org/prompt-library/luxury-miniature-dubai-city-model.jpg)
...
**Source**  
[@silentempiredev](https://x.com/silentempiredev/status/2048086378383384773)

### Diorama de sachet de graines magique

![Diorama de sachet de graines magique](https://cdn.gptimagine.org/prompt-library/magical-seed-packet-diorama.jpg)
...
**Source**  
[@AllaAisling](https://x.com/AllaAisling/status/2048156345518768190)

### Affiche de produits pour chambre Méduse pastel

![Affiche de produits pour chambre Méduse pastel](https://cdn.gptimagine.org/prompt-library/pastel-jellyfish-room-goods-poster.jpg)
...
**Source**  
[@Ayu_AI_0912](https://x.com/Ayu_AI_0912/status/2048309565817766139)

### Affiche de campagne marketing produit - Streetwear haut de gamme

![Affiche de campagne marketing produit - Streetwear haut de gamme](https://cdn.gptimagine.org/prompt-library/product-marketing-high-end-streetwear-campaign-poster.jpg)

**Prompt**

````text
Use the uploaded reference image as the identity source. Create a high-end streetwear campaign poster with the same person captured mid-air in a dynamic floating pose. Clean studio background with {argument name="background gradient" default="soft white to light grey gradient"}. Subject wears a monochrome {argument name="clothing" default="oversized sweatshirt, matching sneakers, and translucent loose pants"}. Add {argument name="smoke color" default="dramatic colored smoke clouds"} swirling around the body, blending with the outfit tone. Strong fashion editorial lighting, sharp details, premium advertisement style, centered composition. Behind the subject, place giant bold 3D block letters spelling “{argument name="brand name" default="[BRAND NAME]"}” across the background instead of any other text, matching the outfit color. Crisp shadows, glossy finish, modern luxury sportswear aesthetic, highly detailed, poster quality.
````

**Source**  
[@Harboris](https://x.com/harboriis/status/2049127746534777209)

### Capture d'écran de personnalisation iOS Merl - Marketing produit

![Capture d'écran de personnalisation iOS Merl - Marketing produit](https://cdn.gptimagine.org/prompt-library/product-marketing-merl-ios-personalization-screenshot.jpg)

**Prompt**

````text
{"type":"app store promotional screenshot","platform":"iOS","style":"clean premium branding, soft 3D mascot illustration, warm minimalist product marketing","brand":{"name":"{argument name=\"app name\" default=\"Merl\"}","primary colors":["warm cream","golden yellow","black","soft orange","lavender accent"]},"canvas":{"aspect_ratio":"9:16 vertical","background":"light beige upper field with a large curved golden-yellow wave rising from the bottom"},"layout":{"sections":[{"title":"hero headline","position":"top-left","count":2,"labels":["Personalize your","Merl experience"]},{"title":"supporting copy","position":"upper-left below headline","count":4,"labels":["Customize agents,","memory, and how","Merl shapes prompts","for your best outputs."]},{"title":"phone mockup","position":"center-right","count":1,"labels":["iPhone displaying the app customization screen"]},{"title":"mascot","position":"bottom-left of phone","count":1,"labels":["small white mascot wearing wizard hat and cape, one arm pointing toward the phone"]},{"title":"brand signature","position":"bottom-center","count":2,"labels":["mascot face icon","Merl"]}]},"device":{"model":"modern iPhone Pro style with dynamic island","angle":"slight rightward perspective tilt","finish":"glossy black metal frame","screen":{"header":{"time":"9:41","center title":"Your Merl","right action":"Done"},"content_sections":[{"title":"BESTIE","count":1,"labels":["bestie"]},{"title":"YEAR","count":4,"labels":["Student","Working pro","Creator","Just curious"]},{"title":"AGE","count":5,"labels":["Under 18","18–24","25–34","35–49","50+"]},{"title":"INTERESTS","count":5,"labels":["Resumes & cover letters","Photos","Image gen","Video","Writing"]},{"title":"HOW MERL WORKS FOR YOU","count":5,"labels":["Memory","Prompt style","Adapt to you","Default model","Response length"]},{"title":"bottom navigation","count":3,"labels":["home icon","center pill button: 288 Merls","profile icon"]}],"selected states":["Just curious","18–24","Resumes & cover letters","Photos","Image gen","Writing"],"toggles":{"count":2,"labels":["Memory on","Adapt to you on"]},"descriptive_rows":["Memory — Merl remembers your preferences and past chats","Prompt style — Friendly, clear, and concise","Adapt to you — Merl adapts prompts and workflows based on your activity","Default model — Merl chooses the best model for every task","Response length — Balanced"]}},"mascot":{"design":"rounded chibi-like white character with dot eyes, small smile, peach blush cheeks","outfit_count":3,"outfit_pieces":["brown wizard hat","golden cape","round neck clasp or bow"],"pose":"standing beside the phone, slightly waving or presenting it"},"typography":{"headline":"large elegant high-contrast serif in black","body":"small clean sans-serif in muted dark gray","logo":"serif wordmark matching the headline"},"lighting":"soft studio lighting with gentle shadows, polished app-advertisement finish","quality":"high-resolution, highly legible UI, consistent brand identity, premium iOS App Store screenshot aesthetic"}
````

**Source**  
[@ashen](https://x.com/ashen_one/status/2049141379482488975#reversed-3)

### Affiche de publicité Pharma Zombie Cure - Marketing produit

![Affiche de publicité Pharma Zombie Cure - Marketing produit](https://cdn.gptimagine.org/prompt-library/product-marketing-zombie-cure-pharma-ad-poster.jpg)

**Prompt**

````text
{"type":"cinematic pharmaceutical apocalypse advertisement poster","product":{"name":"{argument name=\"product name\" default=\"REANIMATEX-Z\"}","taglineTop":"SCIENCE HAS DELIVERED. HUMANITY WILL ENDURE.","introLine":"INTRODUCING","headline":"{argument name=\"headline text\" default=\"REANIMATEX-Z\"}","subheadline":"THE BREAKTHROUGH IN ZOMBIE REANIMATION REVERSAL","format":"injection vial and product box","labelText":["INJECTION","Broad-Spectrum Anti-Reanimation Agent","For Intramuscular Use","10 mL / Multi-Dose Vial"],"claims":[{"title":"TARGETS THE SOURCE","body":"Precisely binds to aberrant proteins caused by the Reanimation Pathogen (RPV-Z), neutralizing the necrotic process at a cellular level."},{"title":"RESTORES THE HUMAN","body":"Promotes neural repair and cognitive function, helping to restore memory, awareness, and personality."},{"title":"BROAD-SPECTRUM PROTECTION","body":"Effective against all known strains of the Reanimation Pathogen. Your best defense."}],"administration":"ADMINISTERED VIA INTRAMUSCULAR INJECTION","administrationDetail":"For rapid absorption and maximum efficacy.","bottomBanner":"THE CURE IS HERE. THE FUTURE IS OURS.","bottomSubbanner":"{argument name=\"bottom slogan\" default=\"REANIMATEX-Z – REVIVING HOPE. RESTORING HUMANITY.\"}","brand":"{argument name=\"company name\" default=\"GENESIS BIOSCIENCES\"}","approval":"For emergency use under the Global Health Defense Act. Approved by the World Health Organization (WHO).","copyright":"© 2024 Genesis Biosciences. All rights reserved."},"scene":{"style":"high-end dystopian biotech promo poster, hyper-real cinematic composite, gritty realism","lighting":"dark moody night lighting with cold blue highlights, smoky atmosphere, dramatic rim light, glossy reflections on glass and metal","colorPalette":["black","charcoal gray","steel blue","electric blue","white"],"background":"ruined city street during a zombie outbreak, crowds of undead figures advancing through smoke and rubble, damaged high-rise buildings, streetlights glowing through haze, military helicopter flying in the upper left sky","environmentDetails":["apocalyptic urban destruction","wet reflective ground","ash and fog in the air","large wall sign reading HUMANITY WILL RISE AGAIN"]},"layout":{"composition":"wide landscape poster with dense ad-style design, left side outbreak scene, center text block, right side product beauty shot","sections":[{"title":"left outbreak panel","position":"left","count":4,"labels":["gloved hand holding vial in foreground","zombie crowd in midground","helicopter in sky","bottom-left slogan block"]},{"title":"center information panel","position":"center","count":6,"labels":["top tagline","intro line","main headline","subheadline","body paragraph","3 feature callouts with circular icons"]},{"title":"right product panel","position":"right","count":4,"labels":["medicine box","standing vial","syringe lying diagonally","company logo and legal text"]}],"textBlocks":["RESTORE. REBUILD. RECLAIM.","Every dose brings us closer to a world free from the undead. Trust Reanimatex-Z to restore humanity, one life at a time."],"iconCount":3},"subjectDetails":{"foregroundHand":"blue nitrile medical glove holding a small clear glass vial with a blue cap between fingers","productObjects":["1 handheld vial on the left","1 boxed package on the right","1 standing vial on the far right","1 syringe in front of the box"],"packagingDesign":"white and pale blue pharmaceutical packaging with subtle DNA helix graphic, modern clinical typography, blue accent band near the bottom of the box","logoStyle":"clean biotech corporate emblem with geometric hexagonal mark"},"rendering":{"finish":"photo-realistic, sharply detailed commercial key art","camera":"slightly wide promotional composition, product-centered perspective","quality":"ultra-detailed, polished poster design, realistic typography integration"}}
````

**Source**  
[@Christophe Gouazé](https://x.com/CGouaze/status/2049113985031520757#reversed-0)

### Publication réseaux sociaux - Affiche teaser tenue boutique Anime Pokémon

![Publication réseaux sociaux - Affiche teaser tenue boutique Anime Pokémon](https://cdn.gptimagine.org/prompt-library/social-media-post-anime-pok-mon-shop-outfit-teaser-poster.jpg)
...
**Source**  
[@ねずみ男(AIイラスト専用)](https://x.com/ratman_aiillust/status/2049107740686204942#reversed-0)

### Miniature YouTube - Miniature webinaire Cyber AI

![Miniature YouTube - Miniature webinaire Cyber AI](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-cyber-ai-webinar-thumbnail.jpg)

**Prompt**

````text
Create a flashy Japanese YouTube thumbnail in a dark futuristic cyber-tech style, 16:9 landscape composition, with a deep navy-to-black background filled with glowing blue circuit-board patterns, connected network nodes, tiny digital squares, and electric energy lines. At the top center, place a small white Japanese headline reading {argument name="headline text" default="センスに頼らないAI時代の新常識"}. In the center, add a massive 2-line Japanese title in metallic silver-white beveled lettering with intense neon-blue outer glow, electric lightning cracking behind and through the letters, reading {argument name="main title" default="AIツール 完全攻略"}. Beneath the main title, place one black horizontal banner with thin gold trim and white serif Japanese text reading {argument name="subheadline text" default="Claude Code 解説LIVE 本日21:00〜"}. On the right side, include 1 cute chibi sheep mascot standing on a glowing blue circular platform, with fluffy light blue and lavender fur, small horns, simple dot eyes, a neutral expression, outlined in purple-blue light, holding a short stick, and surrounded by a red-orange flame aura behind its body. Along the bottom, place 3 glowing futuristic rounded rectangular panels with blue neon borders and dark interiors, evenly spaced left to right. The left panel contains 1 white head-with-circuit icon and the Japanese text {argument name="bottom left label" default="AI生成から次へ進化"}. The center panel contains 1 white upward-trend chart icon and the text "AIでブランディング". The right panel contains 1 white group-and-gear icon and the text "人もAIも動かす戦略". Use extremely high contrast, glossy metallic text effects, layered blue rim lighting, energetic lightning, subtle lens glows, and a premium high-impact webinar thumbnail aesthetic.
````

**Source**  
[@えみ｜AI × クライアントワーク](https://x.com/emi_aifuku/status/2048761642872348947#reversed-0)

### Miniature YouTube - Plan d'action cinématographique dramatique football

![Miniature YouTube - Plan d'action cinématographique dramatique football](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-dramatic-soccer-cinematic-action-shot.jpg)
...
**Source**  
[@Shami](https://x.com/ShamiWeb3/status/2048287581868302683)

### Miniature YouTube - Miniature croissance japonaise flamboyante

![Miniature YouTube - Miniature croissance japonaise flamboyante](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-fiery-japanese-growth-thumbnail.jpg)

**Prompt**

````text
{"type":"Japanese YouTube thumbnail","style":"high-impact flashy growth-marketing thumbnail, dramatic, glossy, fiery, attention-grabbing","canvas":{"aspect_ratio":"16:9","background":"black with orange fire sparks, glowing particles, light streaks, and lens flare"},"headline":{"top_text":"{argument name=\"headline text\" default=\"最短ルートで到達する方法\"}","main_text":["0から","1万人","伸ばす法則"],"sub_text":"やりがちなNG行動も完全解説","main_text_style":{"font":"extra bold Japanese display font","colors":["white","glowing orange-gold"],"effects":"thick black shadow, strong outer glow, metallic heat texture on the orange text, slight distress texture on the white text"}},"graphics":{"count":6,"items":[{"type":"giant upward arrow","position":"top-right sweeping diagonally upward","color":"bright orange-gold","effect":"intense glow, spark trail"},{"type":"bar chart","position":"right side behind character","count":4,"labels":["5,000","7,000","10,000",""],"color":"orange-gold glow"},{"type":"lens flare starburst","position":"top-left","color":"golden orange"},{"type":"diagonal energy streak","position":"bottom-left to center","color":"orange"},{"type":"small spark particles","position":"across entire background","color":"orange and gold"},{"type":"small star icon","position":"above character head","color":"yellow glow"}]},"character":{"count":1,"subject":"cute mascot sheep avatar","position":"bottom-right","appearance":{"body_color":"light blue fluffy wool","face":"cream white","outline":"dark brown line art","expression":"calm closed-eye smile","accessories":"holding a yellow pointer stick in the right hoof"}},"bottom_panels":{"count":3,"style":"black rounded rectangular boxes with bright orange glowing borders","items":[{"icon":"group of people","text":"伸びるアカウントの共通点","position":"bottom-left"},{"icon":"target with arrow","text":"0フォロワー期の戦略","position":"bottom-center"},{"icon":"rising bar chart with arrow","text":"アルゴリズム攻略法","position":"bottom-right"}]},"color_palette":{"primary":["black","white","orange","gold"],"accent":["yellow","light blue"]},"composition":"oversized central typography dominates the frame, with the largest emphasis on 1万人 and 伸ばす法則, supporting mascot on the right, and three informational callout boxes aligned along the bottom, all designed to look like a viral Japanese social media or YouTube growth tutorial thumbnail","quality":"ultra sharp, high contrast, polished thumbnail design, cinematic glow effects"}
````

**Source**  
[@えみ｜AI × クライアントワーク](https://x.com/emi_aifuku/status/2048761642872348947#reversed-1)

### Miniature YouTube - Tutoriel beauté anachronistique

![Miniature YouTube - Tutoriel beauté anachronistique](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-anachronistic-beauty-tutorial.jpg)
...
**Source**  
[@Mr.pinecone](https://x.com/Mrpinecone888/status/2048398131969286552)


## portrait

### Créez la conception de première page la plus réaliste d'un journal vintage présentant ...

![Créez la conception de première page la plus réaliste d'un journal vintage présentant ...](https://cdn.gptimagine.org/prompt-library/create-the-most-realistic-front-page-design-of-a-vintage-newspaper-featuring.jpg)
...
**Source**  
[@Naiknelofar788](https://x.com/Naiknelofar788/status/2047207812800147647)

### Portrait éditorial rétroéclairé onirique

![Portrait éditorial rétroéclairé onirique](https://cdn.gptimagine.org/prompt-library/dreamy-backlit-editorial-portrait.jpg)
...
**Source**  
[@ToroJushiAi](https://x.com/ToroJushiAi/status/2048139425465467248)

### Article vedette du guide de voyage du magazine

![Article vedette du guide de voyage du magazine](https://cdn.gptimagine.org/prompt-library/magazine-travel-guide-feature-article.jpg)
...
**Source**  
[@andis13](https://x.com/andis13/status/2047204384811921764)

### Portrait selfie devant un miroir dans une chambre

![Portrait selfie devant un miroir dans une chambre](https://cdn.gptimagine.org/prompt-library/mirror-selfie-bedroom-portrait.jpg)
...
**Source**  
[@Shinning1010](https://x.com/Shinning1010/status/2045002808903020962)

### Avatar inspiré d'Hermès en monochrome

![Avatar inspiré d'Hermès en monochrome](https://cdn.gptimagine.org/prompt-library/monochrome-hermes-inspired-avatar.jpg)
...
**Source**  
[@jiajia232016](https://x.com/jiajia232016/status/2048044100793032976)

### Profil / Avatar - Portrait anime cyberpunk avec texte facial néon

![Profil / Avatar - Portrait anime cyberpunk avec texte facial néon](https://cdn.gptimagine.org/prompt-library/profile-avatar-cyberpunk-anime-portrait-with-neon-face-text.jpg)
...
**Source**  
[@Anifun AI](https://x.com/Anifun_AI/status/2049393871642345834#reversed-0)

### Profil / Avatar - Fille fantastique élégante dans un jardin violet

![Profil / Avatar - Fille fantastique élégante dans un jardin violet](https://cdn.gptimagine.org/prompt-library/profile-avatar-elegant-fantasy-girl-in-violet-garden.jpg)
...
**Source**  
[@美和](https://x.com/tokikageyomikag/status/2049200427842064715#reversed-1)

### Profil / Avatar - Portrait glamour d'une femme en noir

![Profil / Avatar - Portrait glamour d'une femme en noir](https://cdn.gptimagine.org/prompt-library/profile-avatar-glamorous-woman-in-black-portrait.jpg)
...
**Source**  
[@LJ](https://x.com/XLOOP37/status/2048976490575155202#reversed-1)

### Profil / Avatar - Fond d'écran portrait d'identité professionnelle

![Profil / Avatar - Fond d'écran portrait d'identité professionnelle](https://cdn.gptimagine.org/prompt-library/profile-avatar-professional-identity-portrait-wallpaper.jpg)
...
**Source**  
[@𝗦𝗮𝗻𝗶𝗮](https://x.com/saniaspeaks_/status/2048990448882942051)

### Profil / Avatar - Selfie IA réaliste mais imparfait

![Profil / Avatar - Selfie IA réaliste mais imparfait](https://cdn.gptimagine.org/prompt-library/profile-avatar-realistically-imperfect-ai-selfie.jpg)
...
**Source**  
[@Tz](https://x.com/Tz_2022/status/2049178230762934731)

### Profil / Avatar - Portrait de lapin neigeux en hanfu

![Profil / Avatar - Portrait de lapin neigeux en hanfu](https://cdn.gptimagine.org/prompt-library/profile-avatar-snowy-rabbit-hanfu-portrait.jpg)
...
**Source**  
[@전자넹_특이점](https://x.com/zeonzwane_spud/status/2049099351310692544#reversed-3)

### Profil / Avatar - Portrait hanfu de la dynastie Song

![Profil / Avatar - Portrait hanfu de la dynastie Song](https://cdn.gptimagine.org/prompt-library/profile-avatar-song-dynasty-hanfu-portrait.jpg)
...
**Source**  
[@Shinning](https://x.com/Shinning1010/status/2049013833021145235)

### Portrait éditorial - Brume noire douce

![Portrait éditorial - Brume noire douce](https://cdn.gptimagine.org/prompt-library/soft-black-mist-editorial-portrait.jpg)
...
**Source**  
[@BubbleBrain](https://x.com/BubbleBrain/status/2046434670724907395)

### Jeune femme en robe à paillettes sur les escaliers

![Jeune femme en robe à paillettes sur les escaliers](https://cdn.gptimagine.org/prompt-library/young-woman-in-sequin-dress-on-stairs.jpg)
...
**Source**  
[@XSydneyFan](https://x.com/XSydneyFan/status/2048114180906217566)

### analyse cette photo et donne-moi un prompt JSON détaillé qui la recrée. brea...

![analyse cette photo et donne-moi un prompt JSON détaillé qui la recrée. brea...](https://cdn.gptimagine.org/prompt-library/analyze-this-photo-and-give-me-a-detailed-json-prompt-that-recreates-it-brea.jpg)
...
**Source**  
[@pavellaslov](https://x.com/pavellaslov/status/2047182214304055339)

### Collage de films

![Collage de films](https://cdn.gptimagine.org/prompt-library/movie-collage.jpg)
...
**Source**  
[@chetaslua](https://x.com/chetaslua/status/2044462992176386532)


## character

### Feuille de référence combat danse 16 poses

![Feuille de référence combat danse 16 poses](https://cdn.gptimagine.org/prompt-library/16-pose-dance-combat-reference-sheet.jpg)
...
**Source**  
[@ExquisitMe](https://x.com/ExquisitMe/status/2048143577264402629)

### Illustration de bataille d'arts martiaux anime

![Illustration de bataille d'arts martiaux anime](https://cdn.gptimagine.org/prompt-library/anime-martial-arts-battle-illustration.jpg)
...
**Source**  
[@Tanemomi_Ver2](https://x.com/Tanemomi_Ver2/status/2046063806846214265)

### Affiche visuel clé du personnage avec collage de silhouettes

![Affiche visuel clé du personnage avec collage de silhouettes](https://cdn.gptimagine.org/prompt-library/character-key-visual-poster-with-silhouette-collage.jpg)
...
**Source**  
[@SimplyAnnisa](https://x.com/SimplyAnnisa/status/2049468867106189319)

### Art du personnage visage caché - Notes de chaos

![Art du personnage visage caché - Notes de chaos](https://cdn.gptimagine.org/prompt-library/chaos-notes-hidden-face-character-art.jpg)
...
**Source**  
[@loglogrog](https://x.com/loglogrog/status/2046448773162033240)

### Eleanor du projet White Cat Project

![Eleanor du projet White Cat Project](https://cdn.gptimagine.org/prompt-library/eleanor-from-white-cat-project.jpg)
...
**Source**  
[@yume00112211](https://x.com/yume00112211/status/2048309139013853421)

### Fiche officielle du personnage (JP)

![Fiche officielle du personnage (JP)](https://cdn.gptimagine.org/prompt-library/official-character-sheet-jp.jpg)
...
**Source**  
[@Toshi_nyaruo_AI](https://x.com/Toshi_nyaruo_AI/status/2045025277538107420)

### Carte de référence du personnage Persona5

![Carte de référence du personnage Persona5](https://cdn.gptimagine.org/prompt-library/persona5-character-reference-card.jpg)
...
**Source**  
[@iamrednightS](https://x.com/iamrednightS/status/2045075682837836265)

### Grille de cartes des Saints d'or de Saint Seiya

![Grille de cartes des Saints d'or de Saint Seiya](https://cdn.gptimagine.org/prompt-library/saint-seiya-gold-saints-card-grid.jpg)
...
**Source**  
[@songguoxiansen](https://x.com/songguoxiansen/status/2046476566537080849)


## poster

### Une photo professionnelle de produit d'une eau pétillante froide

![Une photo professionnelle de produit d'une eau pétillante froide](https://cdn.gptimagine.org/prompt-library/a-professional-product-photography-shot-of-a-cold-sparkling-water.jpg)
...
**Source**  
[@meng_dagg695](https://x.com/meng_dagg695/status/2047227172486824002)

### Rapport d'aspect : 9:16 Verticale

![Rapport d'aspect : 9:16 Verticale](https://cdn.gptimagine.org/prompt-library/aspect-ratio-9-16-vertical.jpg)
...
**Source**  
[@GeekCatX](https://x.com/GeekCatX/status/2047220831491858766)

### Bande dessinée / Storyboard - Visuel clé Anime Sky Fantasy

![Bande dessinée / Storyboard - Visuel clé Anime Sky Fantasy](https://cdn.gptimagine.org/prompt-library/comic-storyboard-anime-sky-fantasy-key-visual.jpg)

**Prompt**

````text
A polished anime fantasy key visual in a wide cinematic composition, showing a serene young heroine on the right half of the frame against a vast sky kingdom. She is a beautiful teenage girl with {argument name="hair color" default="long silver-white"} hair, large {argument name="eye color" default="clear blue"} eyes, pale skin, and a calm, slightly wistful smile as she turns her head back toward the viewer over her shoulder. Her hair is very long and windblown, with soft layered bangs and a side ornament: 1 blue crystal hairpiece with silver filigree and trailing blue ribbons. She wears an elegant white-and-blue fantasy outfit with 4 visible main garment elements: 1 white hooded cape draped over her shoulders, 1 deep blue inner dress or tunic, 1 ornate silver armored shoulder and upper sleeve section with engraved details, and 1 blue gemstone brooch set at the chest. The background is a luminous high-altitude fantasy world filled with bright clouds, blue sky, and floating islands; include 3 prominent floating architectural elements: 1 large central floating landmass with castle structures, 1 tall narrow spire emerging from the lower left clouds, and 1 distant towered island near the center. In the upper left sky, depict 1 majestic white dragon with wings spread, flying diagonally above the title area. Add a large stylized Japanese title on the left side with metallic silver and glowing blue typography, reading {argument name="main title" default="白竜の翼と青き記憶"}, with decorative wing motifs integrated into the lettering. Beneath it, add 2 smaller lines of subtitle text in Japanese, centered left: {argument name="episode label" default="第１話"} and {argument name="episode subtitle" default="白銀の空隙"}. Scatter a few white glowing feathers or petals in the air. Use a cool palette of white, silver, and luminous azure, highly detailed linework, soft cel shading, crisp highlights, ethereal lighting, and the feel of a premium light novel cover or fantasy anime promotional poster.
````

**Source**  
[@ぬる（温）](https://x.com/uzuyanurp/status/2049276553536921885#reversed-0)

### Affiche concept sombre épique

![Affiche concept sombre épique](https://cdn.gptimagine.org/prompt-library/dark-epic-concept-poster.jpg)
...
**Source**  
[@A9Quant](https://x.com/A9Quant/status/2046224777208361126)

### Collection de prompts de design minimal

![Collection de prompts de design minimal](https://cdn.gptimagine.org/prompt-library/minimal-design-prompt-collection.jpg)
...
**Source**  
[@akokoi1](https://x.com/akokoi1/status/2045693939584516441)

### Marketing produit - Poster de mode Style Spectrum

![Marketing produit - Poster de mode Style Spectrum](https://cdn.gptimagine.org/prompt-library/product-marketing-style-spectrum-fashion-poster.jpg)

**Prompt**

````text
A high-end fashion editorial poster in a vertical 9:16 format, set inside a serene futuristic circular gallery with smooth beige stone walls, a large round skylight in the ceiling, soft diffused warm lighting, and a sculptural circular platform at the center. The image shows 7 versions of the same young East Asian woman with long dark wavy hair, each styled as a different personality archetype, arranged around the circular platform in an elegant symmetrical composition. The central and largest figure sits on the edge of the platform facing forward, wearing a loose ivory-white button-front blouse and matching relaxed trousers, calm and introspective, becoming the visual anchor. Around her are 6 alternate style personas: 1 woman on the left in a soft cream dress with hair in a bun, gentle and approachable; 1 woman at the back center standing in a sleeveless black tailored outfit, cool and rational; 1 woman on the upper right seated in a light beige cardigan and pale skirt or trousers, casual and relaxed; 1 woman on the lower left in a sharp black blazer and dark outfit, urban minimalist; 1 woman on the lower right in a taupe oversized suit, mature and confident; 1 woman at the bottom front crouching in a cozy cream knit and loose light pants, everyday comfort style. All seven figures have the same identity but different styling, mood, and pose. Use a muted neutral palette of ivory, cream, taupe, beige, stone gray, and black, with soft atmospheric haze, cinematic depth, luxury magazine aesthetics, minimalism, and polished skin. Add elegant Chinese typography integrated into the composition: top headline {argument name="headline text" default="你不只有一种样子"} with smaller English subtitle {argument name="subtitle text" default="Explore your style spectrum"}. Place 6 Chinese style labels with short descriptive taglines near the surrounding personas: 温柔氛围, 清冷知性, 松弛韩系, 都市极简, 轻熟气场, 日常休闲. At the bottom add the Chinese call-to-action {argument name="bottom question" default="你最想成为哪一个？"} and smaller line {argument name="bottom caption" default="评论区告诉我"}. Premium poster design, fashion campaign feel, graceful composition, soft focus, refined and aspirational.
````

**Source**  
[@李岳](https://x.com/liyue_ai/status/2049150348196291003#reversed-0)

### Affiche Narrative de l'Univers Silhouette

![Affiche Narrative de l'Univers Silhouette](https://cdn.gptimagine.org/prompt-library/silhouette-universe-narrative-poster.jpg)
...
**Source**  
[@MrLarus](https://x.com/MrLarus/status/2046627021674168640)

### Affiche Promotionnelle Silicon Valley 2026

![Affiche Promotionnelle Silicon Valley 2026](https://cdn.gptimagine.org/prompt-library/silicon-valley-2026-promo-poster.jpg)
...
**Source**  
[@carsonyungos](https://x.com/carsonyungos/status/2046523198116889064)

### Publication Réseaux Sociaux - Couverture du Magazine Culture Rétro Journée Showa

![Publication Réseaux Sociaux - Couverture du Magazine Culture Rétro Journée Showa](https://cdn.gptimagine.org/prompt-library/social-media-post-showa-day-retro-culture-magazine-cover.jpg)
...
**Source**  
[@Kazuch2ND@AI ART](https://x.com/Kazuch75240438/status/2049292582606496252#reversed-0)

### Affiche Vue Éclatée du Casque VR

![Affiche Vue Éclatée du Casque VR](https://cdn.gptimagine.org/prompt-library/vr-headset-exploded-view-poster.jpg)
...
**Source**  
[@wory＠ホッピング中](https://x.com/wory37303852/status/2045925660401795478#reversed-0)

### Miniature YouTube - Miniature Revenu AI Or Flashy

![Miniature YouTube - Miniature Revenu AI Or Flashy](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-flashy-gold-ai-income-thumbnail.jpg)

**Prompt**

````text
Create a flashy Japanese YouTube thumbnail in a luxurious black-and-gold money-making style, packed with dramatic visual impact and designed to feel viral, celebratory, and high-value. Use a dark black background filled with intense golden light bursts, glitter particles, sparkles, lens flares, and streaking fireworks radiating outward from the center. Scatter shiny gold confetti across the whole frame. Place piles and angled stacks of Japanese yen banknotes in the lower left and lower right background, partially visible and glowing under the gold lighting. In the center, feature huge embossed metallic gold Japanese typography with thick beveled 3D edges, strong highlights, black shadowing, and a premium foil texture. The top headline should read "フォロワー100人未満でも" in bold white Japanese text with a dark outline, centered near the top. The main central text should read "画像生成で" on the upper middle line and "月100万" on the largest line below, both in giant gold 3D serif-style Japanese characters, with "100" especially dominant and oversized. Beneath that, add a wide black banner with gold trim and elegant ornamental corners, containing the subtitle text "0からの実績を完全公開・再現可能メソッド" in white Japanese characters, with "完全公開" highlighted in gold. Along the bottom, place exactly 3 horizontally aligned black-and-gold rounded rectangular callout panels with ornate gold borders and subtle glow. The left panel contains a gold upward-trending chart icon and the text "実績スクショ公開". The center panel contains a gold map pin icon and the text "0→100ロードマップ". The right panel contains a gold rocket icon and the text "今すぐ始める方法". Add small laurel or decorative gold flourishes around these bottom panels. On the right side of the composition, place a cute chibi sheep mascot with fluffy light blue wool, cream-colored horns and ears, a simple neutral face, and a small body, holding an open red book labeled "BOOK". The mascot should overlap the right side of the main text area slightly and be outlined clearly so it stands out from the glittering background. Overall composition should be extremely high contrast, richly saturated gold, glossy, crowded, and optimized as a bold social media thumbnail that instantly communicates wealth, success, and AI image-generation income.
````

**Source**  
[@えみ｜AI × クライアントワーク](https://x.com/emi_aifuku/status/2048761642872348947#reversed-2)

### Affiche Recherche de Foule Où Est [Your Name]

![Affiche Recherche de Foule Où Est \[Your Name\]](https://cdn.gptimagine.org/prompt-library/where-is-your-name-crowd-search-poster.jpg)
...
**Source**  
[@icreatelife](https://x.com/icreatelife/status/2046639884421550482)

### Affiche de propagande des années 1980

![Affiche de propagande des années 1980](https://cdn.gptimagine.org/prompt-library/1980s-propaganda-poster.jpg)
...
**Source**  
[@akokoi1](https://x.com/akokoi1/status/2046558658096738672)

### Affiche d'endossement de voiture par une célébrité

![Affiche d'endossement de voiture par une célébrité](https://cdn.gptimagine.org/prompt-library/celebrity-car-endorsement-poster.jpg)
...
**Source**  
[@johnAGI168](https://x.com/johnAGI168/status/2046945118674932203)


## ui

### Photographie marketing commerciale d'un produit de beauté

![Photographie marketing commerciale d'un produit de beauté](https://cdn.gptimagine.org/prompt-library/beauty-product-commercial-marketing-photograph.jpg)
...
**Source**  
[@AIwithSarah_](https://x.com/AIwithSarah_/status/2047904483359760677)

### Capture d'écran du livestream Douyin d'Elon Musk

![Capture d'écran du livestream Douyin d'Elon Musk](https://cdn.gptimagine.org/prompt-library/elon-musk-douyin-livestream-screenshot.jpg)
...
**Source**  
[@Shinning1010](https://x.com/Shinning1010/status/2046501587762188535)

### Infographie / Visuel éducatif - Slide de présentation keynote produit IA sombre

![Infographie / Visuel éducatif - Slide de présentation keynote produit IA sombre](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-dark-ai-product-keynote-slide.jpg)

**Prompt**

````text
A premium dark presentation slide in a minimalist editorial tech style, widescreen 16:9 layout, matte black background with refined off-white typography and subtle gray divider lines. The overall mood is sleek, cinematic, and high-end, like a product keynote or design-forward AI startup deck. In the top left, place 2 small navigation lines of text: "UI SCENE · OPEN HARNESS" and below it "DEEP AGENTS" in thin uppercase sans serif with generous tracking. In the top right, add a small page indicator reading "07 / 08". The main headline dominates the upper left in large elegant serif Chinese and English mixed typography: {argument name="headline text" default="开放 harness,开放记忆。"}. Below it, add a 2-line Chinese body paragraph in smaller serif text: {argument name="body text" default="解决方案不是让模型供应商替你保管状态,而是把 harness、标准和记忆后端都放回开发者手里。"}. In the left-middle area, create 3 horizontal feature rows separated by thin gray lines, each row using a bold Chinese label on the left, a short Chinese description in the center, and a tiny uppercase English keyword aligned right. Row 1 label: "标准", description: "agents.md / skills 让上下文入口可见。", keyword: "OPEN". Row 2 label: "模型", description: "模型可替换,记忆不应被单一平台绑定。", keyword: "AGNOSTIC". Row 3 label: "存储", description: "Mongo / Postgres / Redis 可作为自有记忆后端。", keyword: "OWNED". On the right side, place a large embedded UI mockup inside a soft light-gray rounded rectangular frame with a subtle shadow, resembling a product dashboard screenshot. The mockup should be monochrome light beige and gray, highly structured, and divided into 3 main columns. Left column: a narrow vertical icon sidebar plus a project/file panel listing items such as "agents.md", "skills", "workflows", "memories", "tools", and a code editor block at the bottom. Center column: a section titled "模型无关" with 4 selectable model rows and small controls, plus 3 feature cards along the bottom. Right column: a section titled "记忆后端" with 3 database cards for MongoDB, Postgres, and Redis, and a lower panel titled "可迁移" showing a code snippet. Include another top card in the mockup titled "开放标准" with tab-like controls. At the bottom left outside the mockup, add a tiny caption line in Chinese and English reading "UI 情景图 · 三张同高画面板测试". At the bottom center, include a carousel indicator made of 8 small dots with the 7th highlighted as a short white pill and the others as dim gray circles. At the bottom right, place a small page number "07". Also add a faint tiny footer note near the lower right edge in Chinese and English, very subtle, such as a presentation metadata line. Use precise grid alignment, lots of negative space, understated luxury, Swiss-style composition, and a polished AI-product keynote aesthetic.
````

**Source**  
[@歸藏(guizang.ai)](https://x.com/op7418/status/2049094944405737512#reversed-3)

### Infographie / Visuel éducatif - Kit de marque pour restaurant italien

![Infographie / Visuel éducatif - Kit de marque pour restaurant italien](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-italian-restaurant-brand-kit-board-2.jpg)

**Prompt**

````text
{"type":"restaurant brand identity board","brand":{"name":"{argument name=\"brand name\" default=\"OLIVORA\"}","industry":"Italian ristorante","tagline":"{argument name=\"tagline\" default=\"BUON CIBO, BELLA COMPAGNIA.\"}","description":"A modern Italian restaurant that celebrates seasonal ingredients, warm hospitality, and timeless flavors. Rooted in tradition, crafted for today.","personality":["Warm","Authentic","Refined","Welcoming"],"essence":"Italian soul, modern experience."},"style":{"aesthetic":"elegant Mediterranean luxury, minimalist editorial branding, refined hospitality design","mood":"premium, calm, organic, artisanal, inviting","materials":["textured paper","matte signage","linen-like surfaces","natural stone","olive wood tones"],"lighting":"soft natural daylight with gentle shadows","palette":[{"name":"FOREST","hex":"#2f3d2f"},{"name":"CREMA","hex":"#f2ede1"},{"name":"SAGE","hex":"#8f9478"},{"name":"TERRACOTTA","hex":"#c97a4e"},{"name":"CHARCOAL","hex":"#2a2a2a"}]},"layout":{"format":"square presentation board","background":"warm off-white","grid":"clean modular multi-panel brand kit layout with thin dividers","sections":[{"title":"BRAND KIT","position":"top-left","count":4,"labels":["ABOUT","BRAND PERSONALITY","BRAND ESSENCE","primary logo"]},{"title":"LOGO VARIATIONS","position":"top-center","count":2,"labels":["horizontal logo","circular seal logo"]},{"title":"COLOR PALETTE","position":"top-center lower","count":5,"labels":["FOREST","CREMA","SAGE","TERRACOTTA","CHARCOAL"]},{"title":"storefront mockup","position":"top-right","count":2,"labels":["awning sign","sidewalk sandwich board"]},{"title":"TYPOGRAPHY","position":"middle-left","count":2,"labels":["PLAYFAIR DISPLAY","MONTSERRAT"]},{"title":"ICONOGRAPHY","position":"middle-right","count":4,"labels":["olive branch","wine glass","pasta bowl","bottle"]},{"title":"PATTERNS & TEXTURES","position":"middle-right lower","count":4,"labels":["olive leaf pattern","forest green texture","cream paper texture","terracotta texture"]},{"title":"BRAND IMAGERY","position":"bottom-left","count":4,"labels":["pasta plate","warm restaurant interior","olive branch close-up","tiramisu dessert"]},{"title":"BRAND APPLICATIONS","position":"bottom-right","count":3,"labels":["menu cover","menu sheet","round coaster"]}]},"logo":{"symbol":"delicate hand-drawn olive branch","wordmark":"high-contrast serif uppercase","subtext":"RISTORANTE","construction":"centered, spacious letterspacing, understated luxury"},"typography":{"primary":"Playfair Display style elegant serif","secondary":"Montserrat style clean sans serif","specimen":"show large Aa plus uppercase, lowercase, and numerals"},"mockups":{"storefront":{"facade":"sunlit stucco exterior with dark green awning","awning_text":"{argument name=\"awning text\" default=\"OLIVORA\"}","details":["glass doorway","black wall lantern","olive tree in planter","freestanding signboard"]},"print_items":["dark green menu cover with olive branch logo","cream menu page with minimal item list","round cream coaster with centered logo"]},"composition":{"dominant_colors":["forest green","cream","sage","terracotta"],"rendering":"photorealistic mockups mixed with clean vector brand presentation","finish":"high-end agency case study board for restaurant branding presentation"}}
````

**Source**  
[@SRKDAN](https://x.com/SRKDAN/status/2049112850770149775#reversed-1)

### Infographie / Visuel éducatif - Mise en page du rapport sur la beauté du visage japonais

![Infographie / Visuel éducatif - Mise en page du rapport sur la beauté du visage japonais](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-japanese-facial-beauty-report-layout.jpg)

**Prompt**

````text
Using REFERENCE_0, turn the uploaded portrait into a clean, premium Japanese aesthetic analysis dashboard titled {argument name="headline text" default="顔立ち美容レポート"}. Keep the same photo as the source image, including the face blur/censor, and place it in a rounded card at the top right. Reformat the output as a white editorial report page with thin gray borders, black typography, and a luxury beauty-consultation layout. Add these 8 report sections: 1) top header with small English text "FACIAL BEAUTY REPORT ✦", the large Japanese title, and the subtitle "あなたらしさを活かし、より魅力的になるための分析レポート"; 2) an OVERVIEW box listing exactly 5 rows: 年齢（推定） 20–24歳, 性別 女性, 顔の形 やや卵型, パーソナル印象 清潔感・親しみやすい・柔らかい, 分析日 2024.05.24; 3) a total score box labeled 総合魅力度スコア with a circular gauge showing {argument name="total score" default="82"}/100 and a small score guide reading 50=平均的 / 70=良い / 85=非常に良い / 90+=優秀; 4) a metrics box with exactly 7 bullet scores: 左右対称性 84/100, 顔の比率（プロポーション） 83/100, 骨格・輪郭 80/100, 肌質 85/100, 目の魅力 85/100, 鼻のバランス 78/100, 口元の魅力 81/100, 全体の調和 83/100; 5) a FACIAL CONTOUR（シンプルライン図） panel showing a simplified line-art face diagram with the blurred face area masked and measurement guides labeled exactly 1/3, 1/3, 1/3 vertically and 1/5 repeated 5 times along the bottom; 6) a 詳細分析 section with exactly 8 rows matching the metrics above and short explanatory Japanese comments; 7) a strengths box titled 強み（あなたの魅力ポイント） with exactly 3 icon-led items: クリアで印象的な目元, なめらかな肌質, バランスの取れた輪郭; 8) an improvements box titled 改善できる点（より魅力を高めるために） with exactly 3 icon-led items: 目の下のクマ, 鼻の立体感, 唇の血色感; 9) a final recommendation row titled 身だしなみ・スタイル改善提案 with exactly 4 columns labeled ヘアスタイル, メイク, スキンケア, ライフスタイル, each with a simple black line icon and short Japanese advice. Add a small footer line on the bottom right reading {argument name="footer text" default="BEAUTY IS BALANCE."}. Overall style: minimalist clinic report, balanced grid layout, soft shadows, rounded panels, black and gray only, highly legible Japanese magazine design.
````

**Source**  
[@あるか | AI自動化](https://x.com/Superficies9/status/2049130725828698418#reversed-0)

### Infographie / Visuel éducatif - Grille d'affiche conceptuelle luxe religion

![Infographie / Visuel éducatif - Grille d'affiche conceptuelle luxe religion](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-luxury-religion-concept-poster-grid.jpg)

**Prompt**

````text
Create a luxurious concept-entity infographic poster about the {argument name="theme" default="religion"}, arranged as a clean 2x2 grid on a deep navy-to-black cinematic background. Each quadrant contains one floating stone island rendered as a highly detailed miniature monument scene, lit with warm golden rim light and soft volumetric shadows, in an elegant dark fantasy editorial style with realistic materials, symmetrical composition, and refined gold typography. Top left: Islam, featuring a grand ornate mosque with a large central dome, smaller domes, two minarets, arched entry, palm trees, stone steps, and glowing windows, on a circular floating island; on the left side, exactly 3 vertical icon labels reading “TAWHID”, “SALAH”, and “QURAN”; on the right side, one decorative plaque with Arabic calligraphy; at the bottom, a crescent symbol above the large gold title “ISLAM”. Top right: Christianity, featuring a Gothic stone church with tall central steeple topped by a cross, pointed arch doorway, stained-glass style windows, small trees, and a fenced stone path on a floating island; on the left side, exactly 3 vertical icon labels reading “FAITH”, “LOVE”, and “BIBLE”; on the right side, one framed quote plaque reading “FOR GOD SO LOVED THE WORLD THAT HE GAVE HIS ONLY BEGOTTEN SON” and “JOHN 3:16”; at the bottom, a cross symbol integrated into the large gold title “CHRISTIANITY”. Bottom left: Hinduism, featuring an elaborate South Indian temple tower rising above a stepped stone complex with smaller shrines, flags, rocky landscaping, and warm interior glow on a floating island; on the left side, exactly 3 vertical icon labels reading “DHARMA”, “KARMA”, and “MOKSHA”; on the right side, one ornamental mandala-like emblem with the Om symbol; at the bottom, an Om symbol above the large gold title “HINDUISM”. Bottom right: Buddhism, featuring a monumental seated Buddha statue in meditation on a layered stone pedestal, surrounded by rocks, bonsai-like trees, and temple steps on a floating island; on the left side, exactly 3 vertical icon labels reading “MINDFULNESS”, “DHARMA”, and “COMPASSION”; on the right side, one framed quote plaque reading “THE MIND IS EVERYTHING. WHAT YOU THINK YOU BECOME. - BUDDHA -”; at the bottom, a Dharma wheel above the large gold title “BUDDHISM”. Keep all 4 sections visually consistent, with premium gold UI frames, engraved icon badges, polished serif lettering, dramatic studio lighting, high contrast, subtle glow, and immaculate centered presentation.
````

**Source**  
[@TWnese](https://x.com/TWnese/status/2049137304682512479#reversed-0)

### Publication réseaux sociaux - Scène d'ascenseur cinématographique

![Publication réseaux sociaux - Scène d'ascenseur cinématographique](https://cdn.gptimagine.org/prompt-library/social-media-post-cinematic-elevator-scene.jpg)
...
**Source**  
[@Leo AIPhi](https://x.com/xiaochou1945/status/2049299191550407147)

### Publication réseaux sociaux - Affiche d'annonce de transfert du PSG

![Publication réseaux sociaux - Affiche d'annonce de transfert du PSG](https://cdn.gptimagine.org/prompt-library/social-media-post-psg-transfer-announcement-poster.jpg)
...
**Source**  
[@UxUi Tega (Design & Ai)](https://x.com/Tegadesigns/status/2049400556578382190#reversed-0)

### Publication réseaux sociaux - Génération de tenue de mode pour réseaux sociaux

![Publication réseaux sociaux - Génération de tenue de mode pour réseaux sociaux](https://cdn.gptimagine.org/prompt-library/social-media-post-social-media-fashion-outfit-generation.jpg)
...
**Source**  
[@Rion Wu](https://x.com/rionaifantasy/status/2049122261249204626)

### Miniature YouTube - Scène d'interview télévisée avec légendes

![Miniature YouTube - Scène d'interview télévisée avec légendes](https://cdn.gptimagine.org/prompt-library/youtube-thumbnail-tv-interview-scene-with-captions.jpg)

**Prompt**

````text
{argument name="aspect ratio" default="16:9 landscape"}. {argument name="model" default="A model girl"} is being asked by an entertainment reporter about {argument name="interview topic" default="a romantic relationship with another male celebrity"}. During a TV interview, a caption saying "{argument name="caption" default="It's a secret❤"}" is added to the screen. The screen is a talk show layout with a picture-in-picture window in the bottom left and a time display in the top right. Configure the screen with captions like 'Breaking News' or 'Exclusive Interview'. The model girl says, 'It's a secret❤' with an appropriate pose, putting a forefinger to her mouth and winking with one eye.
````

**Source**  
[@kai](https://x.com/kai_tetu/status/2048907847841481134)

### Photo de l'interface de chat WeChat sur smartphone

![Photo de l'interface de chat WeChat sur smartphone](https://cdn.gptimagine.org/prompt-library/wechat-chat-interface-smartphone-photo.jpg)
...
**Source**  
[@Gorden_Sun](https://x.com/Gorden_Sun/status/2047178119854145562)

### Capture d'écran de voyage dans le temps YouTube

![Capture d'écran de voyage dans le temps YouTube](https://cdn.gptimagine.org/prompt-library/youtube-time-travel-screenshot.jpg)
...
**Source**  
[@flowersslop](https://x.com/flowersslop/status/2040261168460108213)

### Flux des moments de l'incident de la porte Xuanwu

![Flux des moments de l'incident de la porte Xuanwu](https://cdn.gptimagine.org/prompt-library/xuanwu-gate-incident-moments-feed.jpg)
...
**Source**  
[@Tz_2022](https://x.com/Tz_2022/status/2046523491940225366)


## infographic

### Grille de 100 sujets technologiques

![Grille de 100 sujets technologiques](https://cdn.gptimagine.org/prompt-library/100-technology-topics-grid.jpg)
...
**Source**  
[@chetaslua](https://x.com/chetaslua/status/2046489044243403029)

### Document d'identité de marque de mascotte à 18 panneaux

![Document d'identité de marque de mascotte à 18 panneaux](https://cdn.gptimagine.org/prompt-library/18-panel-mascot-brand-identity-document.jpg)
...
**Source**  
[@Colin_Leeee](https://x.com/Colin_Leeee/status/2044802802149650631)

### Infographic / Edu Visual - Générateur de feuille d'instructions de chorégraphie

![Infographic / Edu Visual - Générateur de feuille d'instructions de chorégraphie](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-choreography-instruction-sheet-generator.jpg)

**Prompt**

````text
Dance Sequence Instruction Sheet [VISUAL STYLE] {argument name="visual style" default="Monochrome grayscale composition"} featuring a highly detailed 3D-rendered {argument name="subject" default="female dancer"}. Designed like a professional choreography guide with a technical, diagram-inspired layout. Clean white background, soft studio lighting, and strong contrast to highlight body movement and posture.
[GRID LAYOUT] Structured 4×4 panel grid (16 frames total), evenly spaced with thin black divider lines. Each panel is identical in size and clearly numbered from 1 to 16 to show a continuous dance progression. [CHARACTER] Use image1 as the base character. The same {argument name="subject" default="female dancer"} appears consistently across all panels with accurate likeness and proportions. [WARDROBE] The dancer wears a stylish, performance-ready outfit: {argument name="outfit" default="a well-fitted top paired with a short, flowy skirt"}. The look should feel modern and visually appealing while still practical for dance movement. Fabric should subtly respond to motion (slight flow and folds), even in grayscale. [PANEL STRUCTURE – EACH FRAME] Top-left: Step number + short dance move title (e.g., “Step 5 – Spin Transition”) Center: Full-body pose capturing a precise moment in the choreography Bottom-left: 3–4 lines of concise instruction describing the move Overlay: Motion arrows and directional guides illustrating how the dancer transitions [MOTION INDICATORS] Incorporate curved arrows for fluid motion, straight arrows for directional steps, and circular indicators for spins or turns. Emphasize rhythm, weight shifts, and body isolation. [RENDER QUALITY] High-detail sculpted 3D style with smooth grayscale shading, subtle shadows, and clean linework. Maintain a polished, concept-art level finish with clarity in every pose. [RESTRICTIONS] No color, no background scenery, no extra characters, no visual clutter—only the dancer and instructional elements.
````

**Source**  
[@Meem](https://x.com/mehvishs25/status/2049119394723459336)

### Infographic / Edu Visual - Diapositive PPT sur la perte de mémoire cinématographique

![Infographic / Edu Visual - Diapositive PPT sur la perte de mémoire cinématographique](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-cinematic-memory-loss-ppt-slide.jpg)

**Prompt**

````text
Create a minimalist cinematic presentation slide on a deep black background in a premium editorial PPT style, widescreen 16:9. The layout is asymmetrical, with a large text block on the left and one documentary-style photo on the upper right, leaving generous negative space. Use elegant high-contrast Chinese typography with an upscale magazine feel. At the top left, place small uppercase microtext reading "PHOTO • HUMAN STORY". Slightly below it, add another small uppercase line reading "MEMORY HAS WEIGHT". The main headline on the left is very large, bold, white Chinese serif text across 2 lines: {argument name="headline text" default="被删除的不是助手，\n是熟悉感。"}. Beneath it, place a smaller Chinese paragraph in white or light gray, 2 lines, reading: {argument name="body text" default="文章里的邮件助手故事很有力量：同一个模板可以重建，但语气、\n偏好、隐性规则，都要重新教一遍。"}. Below that, add a dark translucent quote box with a thin vertical white line at its left edge; inside, include 2 text levels: the quote in Chinese, {argument name="quote" default="没有记忆,agent 很容易被复制;有了记忆,体验才开始变得专属。"}, and a smaller attribution line reading "配图类型 · 人文纪实照片". On the right, insert a single warm-toned humanistic documentary photo: 1 adult person seen from behind, seated at a desk in a dim office, looking at a computer monitor; a desk lamp stands to the left of the monitor, papers are pinned on the wall, and soft daylight comes through a window. The monitor displays a simple white interface with the centered English message {argument name="screen text" default="Your conversational Assistant has been deleted."}. The photo should feel like film photography, muted browns and grays, intimate, reflective, and slightly melancholic. Add small interface-like pagination details: top right "05 / 08", bottom left microtext "PHOTOGRAPHIC ANCHOR · MEMORY LOSS STORY", bottom right small "05", and at the bottom center 8 tiny pagination dots with the 5th dot highlighted as an elongated white pill while the others are dim gray circles. In the extreme bottom right corner, add tiny navigation hints "← → 翻页 · ESC 关闭". Overall mood: editorial, restrained, cinematic, memory and loss, premium keynote slide design, clean spacing, precise alignment, high-end storytelling presentation aesthetic.
````

**Source**  
[@歸藏(guizang.ai)](https://x.com/op7418/status/2049094944405737512#reversed-2)

### Infographic / Edu Visual - Grille de diorama religieux isométrique

![Infographic / Edu Visual - Grille de diorama religieux isométrique](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-isometric-religion-diorama-grid.jpg)

**Prompt**

````text
{"type":"isometric conceptual religion comparison poster","style":"high-detail 3D miniature diorama, polished stone and architectural model aesthetic, soft global illumination, clean studio rendering, subtle floating symbolic objects, square composition divided into 4 equal quadrants","topic":"major world religions represented as iconic architectural entities","layout":{"grid":{"rows":2,"columns":2,"count":4},"sections":[{"title":"BUDDHISM","position":"top-left","count":5,"labels":["lotus flower","hanging lantern","meditating Buddha figure","incense burner","tree"]},{"title":"CHRISTIANITY","position":"top-right","count":5,"labels":["cross 1","cross 2","chalice and communion wafer","Bible","olive branch"]},{"title":"HINDUISM","position":"bottom-left","count":5,"labels":["Om symbol","trident","Ganesha statue","small deity statue","oil lamp"]},{"title":"ISLAM","position":"bottom-right","count":5,"labels":["crescent moon","open Quran on stand","prayer rug","mihrab arch panel","star motif"]}],"divider":"thin white cross-shaped divider between quadrants"},"scenes":[{"religion":"BUDDHISM","base_text":"BUDDHISM","background":"deep midnight blue with warm clouds and light rays","centerpiece":"multi-tier East Asian pagoda temple on a square stone pedestal with broad staircases on two visible sides, small stone lantern, and a leafy tree","palette":"golden beige stone, dark wood, teal roof tiles, warm sunlight"},{"religion":"CHRISTIANITY","base_text":"CHRISTIANITY","background":"soft off-white to pale gray gradient","centerpiece":"large Gothic cathedral on a square stone pedestal with central rose window, nave, buttresses, and two tall bell towers","palette":"light beige stone, cool gray roof, neutral daylight"},{"religion":"HINDUISM","base_text":"HINDUISM","background":"orange-to-blue gradient with bright warm glow","centerpiece":"South Indian temple complex with 3 ornate gopuram towers, landscaped garden, curved path, and lush greenery on a square pedestal","palette":"sandstone beige, green landscaping, warm orange sunlight"},{"religion":"ISLAM","base_text":"ISLAM","background":"teal-to-deep-blue gradient","centerpiece":"grand mosque with central dome, 4 slender minarets, arcaded courtyard, and fountain on a square pedestal","palette":"cool beige stone, blue domes, evening light"}],"rendering":{"camera":"three-quarter isometric view for each quadrant","materials":"carved stone bases with embossed serif capital lettering on 2 visible sides, detailed miniature architecture, crisp edges","lighting":"directional cinematic light tailored to each quadrant, soft shadows, gentle ambient glow","mood":"educational, respectful, elegant, conceptual"}}
````

**Source**  
[@TWnese](https://x.com/TWnese/status/2049137693892985249#reversed-1)

### Infographic / Edu Visual - Diapositive de comparaison minimale du verrouillage IA

![Infographic / Edu Visual - Diapositive de comparaison minimale du verrouillage IA](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-minimal-ai-lock-in-comparison-slide.jpg)

**Prompt**

````text
A minimalist editorial presentation slide in 16:9 format with a warm light-gray paper background, lots of negative space, refined Swiss-style grid layout, and high-end PPT/keynote design aesthetics. The slide is a comparison page about lock-in, using elegant Chinese typography mixed with tiny English navigation text. At the top left, place two small uppercase English breadcrumb lines: “COMPARISON · LOCK-IN” and below it “CLOSED VS OPEN”, in a thin sans-serif with wide tracking. At the top right, place the page indicator “04 / 08”. Center-left across the upper half, add a very large bold black Chinese headline: “真正的锁定，不是模型，是记忆。” On the left half below the headline, create a three-row comparison list separated by thin horizontal gray rules. Row 1 has the bold Chinese label “轻度风险” on the left, with the explanatory sentence “状态存在服务端，换模型后无法恢复线程。” to its right, and a tiny uppercase English keyword aligned far right: “STATE”. Row 2 has the bold label “中度风险”, with the sentence “闭源 harness 的记忆形态不可见,难以迁移。” and the far-right keyword “SHAPE”. Row 3 has the bold label “最高风险”, with the sentence “整个 harness 和长期记忆都在 API 后面。” and the far-right keyword “LOCK-IN”. On the right side of the slide, place a small inset comparison diagram card with a white background and subtle border, containing 2 side-by-side system architecture panels. The left panel represents a closed system in dark gray and muted red accents; the right panel represents an open system in deep blue accents. Each panel should have 5 small top icon tabs, a central highlighted harness block, several stacked rounded rectangular modules below, and a bottom row of 4 small capability icons with short Chinese labels. Keep the inset detailed but small, so it reads as a supporting visual rather than the main focus. At the bottom left, add tiny light-gray Chinese footer text: “布局测试 · 顶部标题 + 下方两段式内容”. At the bottom right, place a small page number “04”. Centered near the bottom edge, add a carousel indicator with exactly 7 small dots, where the 4th dot is a short dark rounded pill indicating the active slide and the other 6 dots are pale gray circles. Also add tiny faint navigation hints at the lower right edge reading “← → 翻页   ESC 关闭”. Use crisp vector text rendering, understated contrast, elegant spacing, and a calm premium infographic style suitable for a business presentation about AI platform comparison and API memory lock-in.
````

**Source**  
[@歸藏(guizang.ai)](https://x.com/op7418/status/2049094944405737512#reversed-1)

### Infographic / Edu Visual - Générateur de carte d'analyse de chiromancie

![Infographic / Edu Visual - Générateur de carte d'analyse de chiromancie](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-palmistry-analysis-card-generator.jpg)

**Prompt**

````text
You are a physiognomy expert proficient in 'Ma Yi Xiang Fa'. Based on the uploaded palm photo, create a magazine-style palmistry chart:
• Accurately analyze the five elements, complexion, and palm line details.
• Strictly maintain the real shape, skin color, and palm lines; no skin smoothing or deformation.
• Use ultra-fine metallic lines and labels (connecting lines should be dashed) to precisely pinpoint the life line, wisdom line, heart line, career line, wealth line, marriage line, and sun line.
Output: Render a high-quality solid color background, easy to read, in Traditional Chinese with clean text.
1. Core Analysis: Include a 'Five Elements Energy Radar Chart' and 'Overall Aura Comments'.
2. Key Cards: Provide concise and accurate 'Personality and Fortune Analysis' for each line.
3. Luck Suggestions: Provide a designed text block.
````

**Source**  
[@套利豪仔🗽](https://x.com/pritipatelfgoo/status/2049095841013772679)

### Diapositive explicative de Momotaro en style hybride

![Diapositive explicative de Momotaro en style hybride](https://cdn.gptimagine.org/prompt-library/momotaro-explainer-slide-in-hybrid-style.jpg)
...
**Source**  
[@やまもん](https://x.com/yammamon/status/2045778624092254603)

### Diagramme d'analyse des couleurs personnelles

![Diagramme d'analyse des couleurs personnelles](https://cdn.gptimagine.org/prompt-library/personal-color-analysis-diagram.jpg)
...
**Source**  
[@AngryTomtweets](https://x.com/AngryTomtweets/status/2046674296559313170)

### Analyse comparative des couleurs des polos

![Analyse comparative des couleurs des polos](https://cdn.gptimagine.org/prompt-library/polo-shirt-color-comparison-analysis.jpg)
...
**Source**  
[@garenaguinaldox](https://x.com/garenaguinaldox/status/2047384051322081738)

### Infographie / Visuel éducatif - Générateur d'infographies éducatives

![Infographie / Visuel éducatif - Générateur d'infographies éducatives](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-educational-infographic-generator.jpg)

**Prompt**

````text
Create a detailed infographic explaining how a {argument name="topic" default="Canadian well (EAHX)"} works.
````

**Source**  
[@AshutoshShrivastava](https://x.com/ai_for_success/status/2049186357168488883)

### Horloge murale analogique indiquant l'heure mondiale

![Horloge murale analogique indiquant l'heure mondiale](https://cdn.gptimagine.org/prompt-library/world-time-analog-clock-wall.jpg)
...
**Source**  
[@Angaisb_](https://x.com/Angaisb_/status/2046666389734179018)

### Inventaire de scène des 100 éléments

![Inventaire de scène des 100 éléments](https://cdn.gptimagine.org/prompt-library/100-elements-scene-inventory.jpg)
...
**Source**  
[@umesh_ai](https://x.com/umesh_ai/status/2046569229189849228)

### Grille d'objets alphabétiques

![Grille d'objets alphabétiques](https://cdn.gptimagine.org/prompt-library/alphabet-object-grid.jpg)
...
**Source**  
[@umesh_ai](https://x.com/umesh_ai/status/2046510988367945983)

### Visualisation d'article type codex sur tableau noir

![Visualisation d'article type codex sur tableau noir](https://cdn.gptimagine.org/prompt-library/codex-chalkboard-article-visualization.jpg)
...
**Source**  
[@gabrielchua](https://x.com/gabrielchua/status/2046778728748048886)

### Recherche LIME sur la conception de médicaments et création d'une infographie détaillée à ce sujet

![Recherche LIME sur la conception de médicaments et création d'une infographie détaillée à ce sujet](https://cdn.gptimagine.org/prompt-library/research-lime-drug-design-and-make-a-detailed-infographic-about-it.jpg)
...
**Source**  
[@WillSpagnoli](https://x.com/WillSpagnoli/status/2047172976463040851)


## game

### Miniature de stream Minecraft d'une VTuber anime

![Miniature de stream Minecraft d'une VTuber anime](https://cdn.gptimagine.org/prompt-library/anime-vtuber-minecraft-stream-thumbnail.jpg)
...
**Source**  
[@rerxmsz06](https://x.com/rerxmsz06/status/2047261622121705782)

### Carte RPG transformée en scène d'événement anime

![Carte RPG transformée en scène d'événement anime](https://cdn.gptimagine.org/prompt-library/rpg-map-to-anime-event-scene.jpg)
...
**Source**  
[@ArtwlDesign](https://x.com/ArtwlDesign/status/2048054726768709769)

### Bande dessinée / Storyboard - League of Legends dans le style de la dynastie Song

![Bande dessinée / Storyboard - League of Legends dans le style de la dynastie Song](https://cdn.gptimagine.org/prompt-library/comic-storyboard-league-of-legends-in-song-dynasty-style.jpg)

**Prompt**

````text
Song Dynasty Gongbi painting, League of Legends character {argument name="character name" default="[Character Name]"}, with the hero's name and a column of small text {argument name="lines" default="[Voice Lines]"} in the bottom right corner.
````

**Source**  
[@欧巴聊AI](https://x.com/hungryturbo/status/2049273060537368803)

### Scène du bar Shinjuku de GTA 6

![Scène du bar Shinjuku de GTA 6](https://cdn.gptimagine.org/prompt-library/gta-6-shinjuku-bar-scene.jpg)
...
**Source**  
[@ismajc](https://x.com/ismajc/status/2048166630933282995)

### Marketing produit - Couverture de magazine de jeu vidéo

![Marketing produit - Couverture de magazine de jeu vidéo](https://cdn.gptimagine.org/prompt-library/product-marketing-video-game-magazine-cover.jpg)

**Prompt**

````text
Create a Video Game magazine cover. The main cover is {argument name="main game" default="Pragmata"}. Add other subjects like {argument name="secondary games" default="Saros, Pokemon Champions, Replaced"} to the cover. The name of the Magazine is {argument name="magazine title" default="Level Up"}
````

**Source**  
[@Keskin](https://x.com/craftian_keskin/status/2049217820450501119)

### Séquence de jeu dans le style GTA 6

![Séquence de jeu dans le style GTA 6](https://cdn.gptimagine.org/prompt-library/gta-6-style-in-game-footage.jpg)
...
**Source**  
[@WolfRiccardo](https://x.com/WolfRiccardo/status/2041187268711321735)

### GTA 6 sur le marché aux fleurs de Bangalore

![GTA 6 sur le marché aux fleurs de Bangalore](https://cdn.gptimagine.org/prompt-library/gta-6-in-bangalore-flower-market.jpg)
...
**Source**  
[@ismajc](https://x.com/ismajc/status/2048174302164394493)

### Affiche créative de publicité pour jeu navigateur

![Affiche créative de publicité pour jeu navigateur](https://cdn.gptimagine.org/prompt-library/browser-game-ad-creative-poster.jpg)
...
**Source**  
[@llllegend0620](https://x.com/llllegend0620/status/2045963764466688065)

### Page d'introduction des personnages de jeu Gal

![Page d'introduction des personnages de jeu Gal](https://cdn.gptimagine.org/prompt-library/gal-game-character-introduction-page.jpg)
...
**Source**  
[@09lyco](https://x.com/09lyco/status/2045281845391323175)

### Tableau de concept de jeu pixel basé sur le thème d'une série télévisée

![Tableau de concept de jeu pixel basé sur le thème d'une série télévisée](https://cdn.gptimagine.org/prompt-library/pixel-game-concept-board-from-tv-drama-theme.jpg)
...
**Source**  
[@sciencedegens](https://x.com/sciencedegens/status/2049359171594903856)

### Grille de 100 objets d'art pixel

![Grille de 100 objets d'art pixel](https://cdn.gptimagine.org/prompt-library/100-pixel-art-items-grid.jpg)
...
**Source**  
[@ProperPrompter](https://x.com/ProperPrompter/status/2046534215311970694)

### Capture d'écran du gameplay en livestream de GTA 6

![Capture d'écran du gameplay en livestream de GTA 6](https://cdn.gptimagine.org/prompt-library/gta-6-livestream-gameplay-screenshot.jpg)
...
**Source**  
[@marmaduke091](https://x.com/marmaduke091/status/2046732155829604550)

### Capture d'écran du gameplay de GTA San Andreas

![Capture d'écran du gameplay de GTA San Andreas](https://cdn.gptimagine.org/prompt-library/gta-san-andreas-gameplay-screenshot.jpg)
...
**Source**  
[@flowersslop](https://x.com/flowersslop/status/2040693687500341568)

### Capture d'écran de la voie du milieu de League of Legends

![Capture d'écran de la voie du milieu de League of Legends](https://cdn.gptimagine.org/prompt-library/league-of-legends-mid-lane-screenshot.jpg)
...
**Source**  
[@underwoodxie96](https://x.com/underwoodxie96/status/2046529342415790275)

### Style Zelda: Tears of the Kingdom

![Style Zelda: Tears of the Kingdom](https://cdn.gptimagine.org/prompt-library/zelda-tears-of-the-kingdom-style.jpg)
...
**Source**  
[@marmaduke091](https://x.com/marmaduke091/status/2040820686751432990)


## comic

### Feuille de référence de danse en 3D niveaux de gris - Bande dessinée / Storyboard

![Feuille de référence de danse en 3D niveaux de gris - Bande dessinée / Storyboard](https://cdn.gptimagine.org/prompt-library/comic-storyboard-3d-grayscale-dance-reference-sheet.jpg)
...
[CHARACTER]
{argument name="subject" default="Young female dancer with an athletic build, ponytail hairstyle, wearing a crop top, baggy pants, and sneakers"}.
The same character must appear consistently in all panels.
[PANEL STRUCTURE – per cell]
Top-left: bold number badge + {argument name="language" default="Korean"} title text
Center: full-body character pose illustration
Bottom-left: {argument name="language" default="Korean"} description text (3–4 lines)
...
**Source**  
[@K](https://x.com/ChillaiKalan__/status/2049007457918198128)

### Storyboard cinématographique : Le Troll de la montagne - Bande dessinée / Storyboard

![Storyboard cinématographique : Le Troll de la montagne - Bande dessinée / Storyboard](https://cdn.gptimagine.org/prompt-library/comic-storyboard-cinematic-storyboard-the-mountain-troll.jpg)

**Prompt**

````text
Storyboard — colored. The {argument name="character" default="troll"} is walking alone in the {argument name="setting" default="mountains, through snow and wind"}. He gets back home to his cave, all exhausted. The troll spots a tiny flower in a beam of light on a ridge outside the cave. Add a shot where focus is on the flower, then focus shifts to the troll and he says "what is this?" in a deep troll voice. He goes in really close and sniffs. He smiles and picks up the little flower, including the dirt around it. Ensure shots are cinematic and have great composition. We don't need the troll in every shot. Include text and instructions.
````

**Source**  
[@Changning Liu](https://x.com/ChangningL29508/status/2049241133650198702)

### Liste de mechas combinant fantasy sombre - Bande dessinée / Storyboard

![Liste de mechas combinant fantasy sombre - Bande dessinée / Storyboard](https://cdn.gptimagine.org/prompt-library/comic-storyboard-dark-fantasy-combining-mecha-lineup.jpg)

**Prompt**

````text
A dramatic dark fantasy mecha lineup on a black smoky studio-like background, rendered as ultra-detailed concept art with a wide cinematic composition. Show exactly 6 sinister biomechanical figures standing side by side on a glossy reflective floor, all designed as parts or forms of a combining robot set. The overall design language is gothic, infernal, and baroque: blackened steel, tarnished silver armor, serrated edges, thorn-like protrusions, skeletal filigree, red glowing cores and eyes, with subtle white-metal highlights and traces of crimson energy. The mood is ominous, majestic, and apocalyptic.
From left to right: first, a towering humanoid overlord mech, the largest figure in the lineup, with a crown-like halo ring behind the head, huge layered black feathered or blade-like wings draping downward, ornate chest armor with a bright central core, multiple red glowing orbs embedded asymmetrically, and a long staff or spear held diagonally. Second, a tall slender angelic-demonic humanoid mech with an elongated body, spiked antler-like crest, narrow waist, blade-like hanging armor panels, and red glowing shoulder nodes, posed upright and regal. Third, a beast unit on four legs, low and aggressive like a demonic wolf or draconic hound, covered in curved blade armor and long swept-back horns, with glowing red eyes and an arched tail or spine silhouette. Fourth, a heavy quadruped siege unit, bulkier and more armored, with a forward head assembly and two large circular shield-like wheel structures mounted on its sides, full of radial spikes and a glowing red core at the center of one wheel. Fifth, a centaur-like or upright beast warrior mech with long legs, layered armor, horned head, and a sharp avian-draconic profile, slimmer than the heavy unit but still imposing, with red lights in the chest and head. Sixth, a symmetrical winged emblem-like unit resembling a mechanical phoenix crest rather than a humanoid body, with two broad metallic wings spread outward around a central halo ring and a tapered hanging tail piece set with 3 visible red gem-like cores.
Keep the palette nearly monochrome except for the glowing reds. Emphasize razor-sharp silhouettes, intricate engravings, layered armor plates, cables and skeletal mechanical details, smoke drifting behind the figures, and faint reflections beneath their feet. The image should feel like a premium concept sheet for a {argument name="theme" default="dark combining robot"} in the style of hyper-detailed dark fantasy sci-fi illustration. Use a panoramic aspect ratio, front-facing lineup presentation, and high contrast lighting that picks out metallic edges against the deep black background.
````

**Source**  
[@Maki@Sunwood AI Labs.](https://x.com/hAru_mAki_ch/status/2049087124490920427#reversed-0)

### Feuille de mouvements d'arts martiaux instructifs - Bande dessinée / Storyboard

![Feuille de mouvements d'arts martiaux instructifs - Bande dessinée / Storyboard](https://cdn.gptimagine.org/prompt-library/comic-storyboard-instructional-martial-arts-movement-sheet.jpg)
...
**Source**  
[@Aijaz](https://x.com/iamsofiaijaz/status/2049045776001564680)

### Strip de bande dessinée rétro pop-art - Bande dessinée / Storyboard

![Strip de bande dessinée rétro pop-art - Bande dessinée / Storyboard](https://cdn.gptimagine.org/prompt-library/comic-storyboard-retro-pop-art-comic-strip.jpg)
...
**Source**  
[@NOOR](https://x.com/Matpocho/status/2049110040158810194)

### Pipeline de court métrage de style Miyazaki

![Pipeline de court métrage de style Miyazaki](https://cdn.gptimagine.org/prompt-library/miyazaki-style-short-film-pipeline.jpg)
...
**Source**  
[@happycapyai](https://x.com/happycapyai/status/2049468986828697940)

### Manga de lancement en huit panneaux de GPT Image 2

![Manga de lancement en huit panneaux de GPT Image 2](https://cdn.gptimagine.org/prompt-library/eight-panel-gpt-image-2-launch-manga.jpg)
...
**Source**  
[@venturetwins](https://x.com/venturetwins/status/2046620134933250409)

### Storyboard de 100 panneaux de Ximen Qing

![Storyboard de 100 panneaux de Ximen Qing](https://cdn.gptimagine.org/prompt-library/ximen-qing-100-panel-storyboard.jpg)
...
**Source**  
[@ianneo_ai](https://x.com/ianneo_ai/status/2047260183769043119)


## photo

### CALMING GREEN TEA Film Kit affiché de face, la boîte ouverte montre un sage doux-...

![CALMING GREEN TEA Film Kit affiché de face, la boîte ouverte montre un sage doux-...](https://cdn.gptimagine.org/prompt-library/calming-green-tea-film-kit-displayed-frontally-the-open-box-shows-soft-sage.jpg)
...
**Source**  
[@ZaraIrahh](https://x.com/ZaraIrahh/status/2047180061657452601)

### Fujifilm Portrait de couple

![Fujifilm Portrait de couple](https://cdn.gptimagine.org/prompt-library/fujifilm-couple-portrait.jpg)
...
**Source**  
[@BubbleBrain](https://x.com/BubbleBrain/status/2046502288102170757)

### Fujifilm Portrait scolaire à la fraise

![Fujifilm Portrait scolaire à la fraise](https://cdn.gptimagine.org/prompt-library/fujifilm-strawberry-school-portrait.jpg)
...
**Source**  
[@BubbleBrain](https://x.com/BubbleBrain/status/2046483268019884384)

### Korean Idol Portrait en collage 3x3

![Korean Idol Portrait en collage 3x3](https://cdn.gptimagine.org/prompt-library/korean-idol-3x3-collage-portrait.jpg)
...
**Source**  
[@BubbleBrain](https://x.com/BubbleBrain/status/2046151898621993364)

### Profil / Avatar - Séance photo de mode décontractée en grille

![Profil / Avatar - Séance photo de mode décontractée en grille](https://cdn.gptimagine.org/prompt-library/profile-avatar-casual-fashion-grid-photoshoot.jpg)
...
**Source**  
[@Keskin](https://x.com/craftian_keskin/status/2048848908999135645)

### Publication sur les réseaux sociaux - Portrait nocturne pluvieux atmosphérique

![Publication sur les réseaux sociaux - Portrait nocturne pluvieux atmosphérique](https://cdn.gptimagine.org/prompt-library/social-media-post-atmospheric-nighttime-rainy-portrait.jpg)

**Prompt**

````text
A cinematic nighttime photo of {argument name="reference photo" default="your photo as reference"} sitting alone at a wet bus
...
**Source**  
[@Harboris](https://x.com/harboriis/status/2049081194156020046)

### Publication sur les réseaux sociaux - Célébration du trophée de la Premier League sous la pluie

![Publication sur les réseaux sociaux - Célébration du trophée de la Premier League sous la pluie](https://cdn.gptimagine.org/prompt-library/social-media-post-rainy-premier-league-trophy-celebration.jpg)

**Prompt**

````text
A dramatic sports photograph of a {argument name="football player" default="Manchester City player"} in a {argument name="team jersey color" default="sky blue"} kit standing center frame in a rainy stadium, lifting the English Premier League trophy high above his head with both hands. The large silver trophy has a gold crown on top, 2 pale blue ribbons hanging from the handles, and the visible engraved text "Premier League" on the front. The player wears a modern football jersey with dark sponsor text reading "ETIHAD AIRWAYS" and a small chest crest, with arms fully extended upward in a triumphant victory pose. Compose it as a tight vertical crop from mid-torso upward, with the trophy dominating the upper center and partially covering the player's head. Add heavy falling rain, wet reflective metal, moody overcast lighting, shallow depth of field, and a blurred stadium crowd in the background. On the right side of the background, include a bright blue electronic screen with the large glowing word {argument name="scoreboard text" default="GOAL"}. Photorealistic editorial sports photography, high detail, natural stadium colors, celebration moment, slightly telephoto look, crisp focus on the trophy and upper body.
````

**Source**  
[@Tony](https://x.com/Oghener0/status/2049068146984653251#reversed-0)

### Publication sur les réseaux sociaux - Prompt de collage de instantanés de voyage

![Publication sur les réseaux sociaux - Prompt de collage de instantanés de voyage](https://cdn.gptimagine.org/prompt-library/social-media-post-travel-snapshot-collage-prompt.jpg)
...
**Source**  
[@麻酱AI实验室](https://x.com/zhongying14/status/2049128619134300200)

### Portrait Idol dans un doux brouillard noir

![Portrait Idol dans un doux brouillard noir](https://cdn.gptimagine.org/prompt-library/soft-black-mist-idol-portrait.jpg)
...
**Source**  
[@BubbleBrain](https://x.com/BubbleBrain/status/2046518189509734903)

### Photographie produit ultra-réaliste d'une glace soft-serve à la fraise riche...

![Photographie produit ultra-réaliste d'une glace soft-serve à la fraise riche...](https://cdn.gptimagine.org/prompt-library/ultra-realistic-product-photography-of-a-rich-strawberry-soft-serve-ice-cream.jpg)
...
**Source**  
[@ZaraIrahh](https://x.com/ZaraIrahh/status/2047179916161212542)

### Instantané de la famille d'appareils photo numériques 2003

![Instantané de la famille d'appareils photo numériques 2003](https://cdn.gptimagine.org/prompt-library/2003-digital-camera-family-snapshot.jpg)
...
**Source**  
[@pangyusio](https://x.com/pangyusio/status/2046991223395950810)

### Qualité RAW iPhone - Station de métro

![Qualité RAW iPhone - Station de métro](https://cdn.gptimagine.org/prompt-library/raw-iphone-quality-subway-station.jpg)
...
**Source**  
[@WolfRiccardo](https://x.com/WolfRiccardo/status/2041192232623972441)

### Panorama équirectangulaire 360

![Panorama équirectangulaire 360](https://cdn.gptimagine.org/prompt-library/360-equirectangular-panorama.jpg)
...
**Source**  
[@LexnLin](https://x.com/LexnLin/status/2046725722320888313)

### Photo candide de métro

![Photo candide de métro](https://cdn.gptimagine.org/prompt-library/subway-candid-photo.jpg)
...
**Source**  
[@AntCaveClub](https://x.com/AntCaveClub/status/2047136306485133428)

### Esthétique point-and-shoot des années 90

![Esthétique point-and-shoot des années 90](https://cdn.gptimagine.org/prompt-library/90s-point-and-shoot-aesthetic.jpg)
...
**Source**  
[@sunyunran](https://x.com/sunyunran/status/2047241649957503308)


## illustration

### Bande dessinée / Storyboard - Affiche de remise des diplômes épique narrative

![Bande dessinée / Storyboard - Affiche de remise des diplômes épique narrative](https://cdn.gptimagine.org/prompt-library/comic-storyboard-epic-narrative-graduation-poster.jpg)

**Prompt**

````text
Automatically generate a collectible epic narrative poster based on my portrait (Graduation Photo: A giant silhouette of my profile serves as the outer outline, inside which a complete worldview, iconic scenes, character relationships, symbolic icons, key buildings, creatures, props, and atmosphere most fitting the theme (Campus + Graduation) automatically grow. The overall style is a high-end silhouette-filled narrative synthesis with double-exposure associations, but leaning more towards a fusion of movie posters and dreamlike watercolor illustration styles. Soft atmospheric perspective, light fogging transitions, paper grain, edge white space and brush marks, large areas of negative space, restrained and high-end layout, quiet, grand, sacred, nostalgic, poetic, and legendary. Style, color, scene, and material are all automatically adapted according to the theme; all elements must be strongly bound to the theme, instantly recognizable, not messy, no stiff collages, no templated backgrounds, and no cheap fantasy assets. If there is text, use English. My school is {argument name="school name" default="School Name"}.
````

**Source**  
[@欧巴聊AI](https://x.com/hungryturbo/status/2049275513634763052)

### Bande dessinée / Storyboard - Garçon streetwear aux oreilles de renard dans une ville steampunk

![Bande dessinée / Storyboard - Garçon streetwear aux oreilles de renard dans une ville steampunk](https://cdn.gptimagine.org/prompt-library/comic-storyboard-fox-eared-streetwear-boy-in-steampunk-city.jpg)
...
**Source**  
[@狐神ゆん](https://x.com/yunyun_802/status/2049037618164482358#reversed-0)

### Bande dessinée / Storyboard - Chevalier à cheveux roses de la cathédrale

![Bande dessinée / Storyboard - Chevalier à cheveux roses de la cathédrale](https://cdn.gptimagine.org/prompt-library/comic-storyboard-pink-haired-cathedral-knight.jpg)

**Prompt**

````text
A full-body anime fantasy heroine in a grand stained-glass cathedral, viewed from a dramatic low angle. She is a beautiful young knight-princess with very long, flowing twin-tail hair in {argument name="hair color" default="pastel pink"}, the hair streaming outward in luminous ribbons as if caught by magical wind. Her face is intentionally obscured by a simple rectangular blur block. She wears ornate white and deep royal blue ceremonial armor with lavish gold filigree, a fitted breastplate, layered shoulder armor, long armored sleeves, a short blue skirt with gold trim, white thigh-high stockings with lace tops, and intricate gold knee and shin guards. A large crimson cape with a pale inner lining billows around her. One hand rests near her chest while the other hangs gracefully at her side. At her hip is an elegant sword with a glowing blue blade and a highly decorated gold-and-jewel hilt. The setting is flooded with radiant sunlight pouring through towering multicolored stained-glass windows and gothic arches, filling the scene with sparkling highlights, prism-like reflections, floating glitter, and magical particles. Use an ultra-detailed, highly polished anime illustration style with rich gemlike colors, intense backlighting, glossy surfaces, shimmering metal, dynamic cloth motion, and a majestic holy-fantasy atmosphere. Emphasize cinematic composition, heroic presence, and breathtaking luminous detail.
````

**Source**  
[@星宮書房](https://x.com/hoshimiya_shobo/status/2049270893910872064#reversed-0)

### Bannière d'anime Sayori rêveuse

![Bannière d'anime Sayori rêveuse](https://cdn.gptimagine.org/prompt-library/dreamy-anime-sayori-banner.jpg)
...
**Source**  
[@mirochill](https://x.com/mirochill/status/2047639852485620070)

### Infographie / Visuel éducatif - Génération d'encyclopédie animale détaillée

![Infographie / Visuel éducatif - Génération d'encyclopédie animale détaillée](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-detailed-animal-encyclopedia-generation.jpg)

**Prompt**

````text
[Animal Name]
{argument name="animal name" default="insert animal name here"}
[Objective]
Complete a large-format animal encyclopedia plate at a sellable quality level as a single illustration. Generate a publishing-quality plate that balances scientific accuracy with visual appeal.
[Output Format]
- Include all information in one image
- Aspect Ratio: 16:9
- Quality: High (essential for ensuring precision of small text, fine lines, and labels)
[Screen Design Principles]
Layout, zoning, information priority, margin design, typography, decorative elements, and color palette should all be determined autonomously by GPT based on the animal's characteristics, habitat, and classification. Design a layout best suited for this specific animal without being bound by templates.
[Essential Elements to Include]
Integrate the following elements naturally into one frame:
1. Main Specimen Drawing
- Full body of adult depicted with maximum precision
- Scientifically accurate colors, patterns, and proportions
- Scientific name (italicized), common name, and classification info (Order, Family, Genus)
- Scale bar or size comparison
2. Growth/Development Record
- Step-by-step illustration of changes from juvenile to adult
- Concise labels for each stage
3. Ecological/Behavioral Depiction
- Action scenes in natural environments (foraging, predation, breeding, territoriality, etc.)
- Include habitat vegetation and terrain in the background
4. Morphological Details
- Close-ups of characteristic parts (claws, fangs, feathers, scales, eyes, etc.)
- Magnified depictions of surface textures
5. Distribution/Habitat Range
- World or regional distribution map
- Description of habitat types
6. Data Notations
- Length, weight, lifespan, diet, conservation status (IUCN, etc.)
- Easy-to-read table or icon format
[Style Specification]
- Publisher-quality natural history encyclopedia
- Realistic botanical/naturalist painting touch (19th-century naturalist precision + modern color expression)
- Paper texture: Cream-colored hot-press watercolor paper or parchment style
- Font: Unified serif. Scientific names in italics; data can use mixed small sans-serif fonts
- Border: Thin ink border + classical plate decoration
- Overall color scheme, layout tone, and page design optimized by GPT based on habitat, classification, and ecology
[Most Important Instruction]
Deeply understand the unique ecology, cultural significance, and taxonomic features of this animal to design a page that feels like it was "made just for this animal." Visualize the essence of the animal rather than using a generic template. Ensure all text is actually rendered within the frame, leaving no empty labels.
````

**Source**  
[@あかくま屋](https://x.com/aokuma0219/status/2049273535043129624)

### Affiche hommage en lavis d'encre pour Chen Uen

![Affiche hommage en lavis d'encre pour Chen Uen](https://cdn.gptimagine.org/prompt-library/ink-wash-tribute-poster-for-chen-uen.jpg)
...
**Source**  
[@mob_17](https://x.com/mob_17/status/2048118645017219381)

### Profil / Avatar - Portrait fantastique aux cheveux bleus éthérés

![Profil / Avatar - Portrait fantastique aux cheveux bleus éthérés](https://cdn.gptimagine.org/prompt-library/profile-avatar-ethereal-blue-haired-fantasy-portrait.jpg)
...
**Source**  
[@𝑳𝒊𝒊𝒈𝒋𝒎](https://x.com/lchngjin91/status/2048836910676926484#reversed-0)

### Publication sur les réseaux sociaux - Fille elfe confuse devant un bureau pastel

![Publication sur les réseaux sociaux - Fille elfe confuse devant un bureau pastel](https://cdn.gptimagine.org/prompt-library/social-media-post-confused-elf-girl-at-pastel-desk.jpg)
...
**Source**  
[@える](https://x.com/el_el_san/status/2049164203542679602#reversed-0)

### Publication sur les réseaux sociaux - Croquis d'enseigne vintage

![Publication sur les réseaux sociaux - Croquis d'enseigne vintage](https://cdn.gptimagine.org/prompt-library/social-media-post-vintage-sign-painter-sketch.jpg)
...
**Source**  
[@Ashish Sheth](https://x.com/commanderdgr8/status/2049347770725912874)

### Présentation détaillée de GPT-Image-2

![Présentation détaillée de GPT-Image-2](https://cdn.gptimagine.org/prompt-library/gpt-image-2-detail-showcase.jpg)
...
**Source**  
[@liyue_ai](https://x.com/liyue_ai/status/2045000106919997637)

### Visuel clé : fille mecha dans une ville maritime

![Visuel clé : fille mecha dans une ville maritime](https://cdn.gptimagine.org/prompt-library/mecha-girl-sea-city-key-visual.jpg)
...
**Source**  
[@old_pgmrs_will](https://x.com/old_pgmrs_will/status/2046144801071079612)

### Nouvelle illustration florale chinoise minimaliste

![Nouvelle illustration florale chinoise minimaliste](https://cdn.gptimagine.org/prompt-library/new-chinese-minimalist-floral-illustration.jpg)
...
**Source**  
[@liyue_ai](https://x.com/liyue_ai/status/2047180347448914195)

### Illustration douce et poétique pour livre d'enfant avec textures d'aquarelle et de gouache...

![Illustration douce et poétique pour livre d'enfant avec textures d'aquarelle et de gouache...](https://cdn.gptimagine.org/prompt-library/soft-poetic-children-s-book-illustration-with-watercolor-and-gouache-textures.jpg)
...
**Source**  
[@dotey](https://x.com/dotey/status/2047174895293849972)

### Portrait demi-corps féminin de fantasy orientale

![Portrait demi-corps féminin de fantasy orientale](https://cdn.gptimagine.org/prompt-library/eastern-fantasy-female-half-portrait.jpg)
...
**Source**  
[@liyue_ai](https://x.com/liyue_ai/status/2046962895775580442)

### Scène sombre de mythologie de la crête lion-chameau

![Scène sombre de mythologie de la crête lion-chameau](https://cdn.gptimagine.org/prompt-library/lion-camel-ridge-dark-myth-scene.jpg)
...
**Source**  
[@MANISH1027512](https://x.com/MANISH1027512/status/2045743158860878312)

### Illustration surréaliste d'une ville japonaise futuriste

![Illustration surréaliste d'une ville japonaise futuriste](https://cdn.gptimagine.org/prompt-library/surreal-japanese-futuristic-city-illustration.jpg)
...
**Source**  
[@Tresmort](https://x.com/Tresmort/status/2047105322863460496)

### Test de prompt pour une étagère en bois

![Test de prompt pour une étagère en bois](https://cdn.gptimagine.org/prompt-library/wooden-bookshelf-prompt-test.jpg)
...
### Tableau de décomposition du design industriel du mode voiture Bumblebee

![Tableau de décomposition du design industriel du mode voiture Bumblebee](https://cdn.gptimagine.org/prompt-library/bumblebee-car-mode-industrial-design-breakdown-board-20260511.jpeg)
...
### Conversion d'arrière-plan de musée d'anime

![Conversion d'arrière-plan de musée d'anime](https://cdn.gptimagine.org/prompt-library/anime-museum-background-conversion.jpg)
...
**Source**  
[@Dakiny](https://x.com/Dakiny/status/2048175219966394695)

### Maquette de remplacement d'image principale e‑commerce pour vêtements d'animaux

![Maquette de remplacement d'image principale e‑commerce pour vêtements d'animaux](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-pet-apparel-replacement-mockup.jpg)
...
**Source**  
[@中国輸入代行ラクファースト【RAKU FIRST公式】](https://x.com/RakuFirst/status/2048987964513149244#reversed-3)

### Refonte de publicité mode bohème à partir d'image principale e‑commerce

![Refonte de publicité mode bohème à partir d'image principale e‑commerce](https://cdn.gptimagine.org/prompt-library/e-commerce-main-image-reference-to-boho-fashion-ad-remake.jpg)
...
**Source**  
[@橙小禾](https://x.com/linarich0015/status/2049104334202319181#reversed-0)

### Diapositive de comparaison de conversion de publicité voyage pour infographie/visuel éducatif

![Diapositive de comparaison de conversion de publicité voyage pour infographie/visuel éducatif](https://cdn.gptimagine.org/prompt-library/infographic-edu-visual-travel-ad-conversion-comparison-slide.jpg)

**Prompt**

````text
{"type":"comparison presentation slide with two large poster-layout travel advertisements","style":"clean Japanese business presentation, white background, black divider lines, screenshot-like composite layout","canvas":{"aspect_ratio":"16:9","background":"white"},"layout":{"sections":[{"title":"left comparison area","position":"top-left and bottom-left","count":3,"labels":["元画像 GPT-Image-2で生成","Canva Magic layers","Magic Layers"]},{"title":"right comparison area","position":"top-right and bottom-right","count":2,"labels":["自作ツールpptx(改良中)"]}],"dividers":"one thick vertical divider near center and one thick horizontal divider across the middle, with thin black borders around the ad boards","composition":"top row shows source on the left and converted output on the right; bottom row shows enlarged reconstructed layouts side by side"},"text_elements":{"top_left_heading":"元画像 GPT-Image-2で生成","bottom_left_brand":"Canva Magic layers","bottom_right_label":"自作ツールpptx(改良中)"},"embedded_ad_design":{"type":"Japanese travel magazine / tourism app promotional brochure","count":4,"brand_name":"旅色","issue":"06","subtitle":"TABIIRO","theme":"sunset coastal shrine trip in Japan","color_palette":["sky blue","sunset gold","warm beige","white","black"],"main_pages":4,"page_descriptions":["cover page with blue sky background, traditional shrine building, and a woman in a straw hat seen from behind in the lower left, large white Japanese headline text, yellow circular badge, and small weather-style icon at the top right","double-page sunset spread with a torii gate in the water, glowing sun near the horizon, a vertical sequence of 4 small yellow numbered markers, and a bottom strip of 4 rectangular food and travel photos","page featuring a large sunset cliff image with Japanese copy, 3 circular destination thumbnails in a row, a pale yellow recommendation box, and a small scenic photo of a woman raising her arms by the sea","bottom information strip with 5 square feature icons, a smartphone mockup held by a hand, a QR code, and 2 app store badges"]},"visual_details":{"canva_logo":{"present":true,"position":"left center","description":"purple layered square icon with a small New badge above, and the words Magic Layers below"},"reconstruction_difference":"the right-side output arranges the same ad components as separated editable blocks with tighter alignment and visible modularity","ad_components_count":{"circular_thumbnails":3,"bottom_feature_icons":5,"app_store_badges":2,"qr_codes":1,"small_bottom_strip_photos":4}},"rendering":"flat presentation screenshot, crisp typography, high-resolution UI/document mockup aesthetic"}
````

**Source**  
[@中崎工房 | AIで1時間の仕事を5分で終わらせる人](https://x.com/nakazakifam/status/2049253863849595227#reversed-0)

### Transformation de tenue de studio de luxe

![Transformation de tenue de studio de luxe](https://cdn.gptimagine.org/prompt-library/luxury-studio-outfit-transformation.jpg)
...
**Source**  
[@Abdullah__Ai7](https://x.com/Abdullah__Ai7/status/2048083022315159595)

### Refonte de couverture Rolo réaliste 4K pour le marketing produit

![Refonte de couverture Rolo réaliste 4K pour le marketing produit](https://cdn.gptimagine.org/prompt-library/product-marketing-4k-realistic-rolo-cover-remake.jpg)
...
**Source**  
[@Virto](https://x.com/virto_exe/status/2049172905208971720#reversed-1)

### Profil / Avatar - Fille anime en photo cinématographique

![Profil / Avatar - Fille anime en photo cinématographique](https://cdn.gptimagine.org/prompt-library/profile-avatar-anime-girl-to-cinematic-photo.jpg)
...
**Source**  
[@maku](https://x.com/maku67879787/status/2049040029612486845#reversed-0)

### :

![:](https://cdn.gptimagine.org/prompt-library/profile-avatar-old-photo-restoration-to-dslr-portrait.jpg)
...
**Source**  
[@摆烂程序媛](https://x.com/wanerfu/status/2049006709692359015#reversed-1)

### Portrait vintage restauré d'une mère et d'un enfant

![Portrait vintage restauré d'une mère et d'un enfant](https://cdn.gptimagine.org/prompt-library/restored-vintage-mother-and-child-portrait.jpg)
...
**Source**  
[@khaiinit](https://x.com/khaiinit/status/2047219694130827273)

### :

![:](https://cdn.gptimagine.org/prompt-library/create-a-landing-page-using-this-image-as-a-reference-for-style-and-color-gra.jpg)
...
**Source**  
[@D_studioproject](https://x.com/D_studioproject/status/2047212826264211540)

### Modifiez cette image afin que le montant total passe à 244,5 baht. Vous pouvez modifier th...

![Modifiez cette image afin que le montant total passe à 244,5 baht. Vous pouvez modifier th...](https://cdn.gptimagine.org/prompt-library/edit-this-image-so-that-total-amount-changes-to-244-5-baht-you-can-change-th.jpg)
...
**Source**  
[@elliscrosby](https://x.com/elliscrosby/status/2047211507596071235)

### :

![:](https://cdn.gptimagine.org/prompt-library/pro-instagram-photo-enhancement.jpg)
...
**Source**  
[@dezainaz_ceo](https://x.com/dezainaz_ceo/status/2047172512551977162)
